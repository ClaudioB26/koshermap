...
@section('title', 'Países - KosherStatus')
...
@section('content')
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition text-center border border-gray-100 flex flex-col items-center">
