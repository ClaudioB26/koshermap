...
<h2>למה התנור צריך שיטה כה קיצונית</h2>
<p>פנים התנור מגיע לטמפרטורות גבוהות מאוד בכל שימוש, כך שכל שאריות שנספגו נחשבות "אפויות" ברמה עמוקה בהרבה מאשר בסיר. לכן שיטה מתונה יותר כמו הגעלה (טבילה במים רותחים) אינה מספיקה כאן: התנור זקוק לליבון, ניקוי עצמי בחום יבש עז, שפועל לפי אותו עיקרון של "כבולעו כך פולטו" המשמש בכלי מתכת, רק דרך אש במקום מים.</p>

<h2>ההליך צעד אחר צעד</h2>
<ol>
<li>לנקות את התנור ביסודיות, להסיר כל לכלוך ושאריות מזון נראות לעין, כולל אטם הדלת וכל פינה שבה מצטבר שומן.</li>
<li>לא להשתמש בתנור במשך 24 שעות לפני ההכשרה.</li>
<li>להפעיל את התנור בטמפרטורה הגבוהה ביותר האפשרית (רצוי באמצעות פונקציית הניקוי העצמי, אם קיימת) למשך שעה לפחות, עד שהמשטחים הפנימיים מלובנים.</li>
</ol>

<h2>רשתות, תבניות ומשטחי זכוכית</h2>
<p>רשתות ותבניות מתכת ניתן בדרך כלל להכשיר בנפרד באמצעות הגעלה במים רותחים, בעוד שמשטחי זכוכית או אמייל בדרך כלל דורשים ליבון מאחר שהם חומרים סופגים יותר. הזכוכית, בפרט, היא אחד החומרים השנויים ביותר במחלוקת בהלכות כשרות: יש דעות שרואות בה חומר שאינו סופג כלל, ויש הדורשות אותו חום עז כמו במתכת.</p>

<h2>תנורים שאינם עומדים בליבון</h2>
<p>תנורים מודרניים מסוימים, במיוחד כאלה עם חלקי פלסטיק, לוחות מגע אלקטרוניים או ציפויים מיוחדים, לא תוכננו לעמוד בטמפרטורה הנדרשת לליבון ועלולים להינזק או אף להוות סכנת שריפה. במקרים אלה, עדיף להחליף את התנור לחלוטין להתחלה כשרה חדשה, במקום לכפות שיטת הכשרה שהמכשיר לא תוכנן עבורה.</p>

<h2>שאלות נפוצות</h2>
<p><strong>האם מחזור הניקוי העצמי לבדו נחשב כליבון?</strong><br>
לפי רוב הדעות, כן, מכיוון שהוא מגיע לטמפרטורה הנדרשת, אך כדאי לוודא שהמחזור מכסה את כל המשטחים הפנימיים, כולל הדלת.</p>
<p><strong>האם צריך להכשיר את התנור בכל פעם שמבשלים בטעות משהו לא כשר?</strong><br>
אם מדובר באירוע חד-פעמי, התייעצות עם רב לגבי המקרה הספציפי היא הדרך הבטוחה ביותר, מכיוון שהתשובה עשויה להיות תלויה במאכל, בטמפרטורה ובזמן שהותו בפנים.</p>
<p><strong>האם ניתן להכשיר תנור לשימוש בשרי וחלבי כאחד?</strong><br>
משפחות רבות מעדיפות לייעד את התנור לקטגוריה אחת מלכתחילה, או להשתמש בתבניות ובניירות אפייה נפרדים לכל שימוש, במקום להכשיר אותו שוב ושוב.</p>

<h2>להמשך קריאה</h2>
<p>לגבי המיקרוגל, שמשתמש בשיטה שונה המבוססת על אדים במקום חום יבש, ראו <a href="/articulos/kasherizar-microondas">איך מכשירים מיקרוגל</a>. לגבי מדיח הכלים, אחד המכשירים השנויים ביותר במחלוקת בין הפוסקים, ראו <a href="/articulos/kasherizar-lavavajillas">איך מכשירים מדיח כלים</a>.</p>',
            ],
            'kasherizar-microondas' => [
...
<h2>למה הוא מעורר כל כך הרבה מחלוקת בין הפוסקים</h2>
<p>בשונה מתנור או ערכת סירים, למדיח הכלים יש עשרות פינות נסתרות, מסנן שאוגר חלקיקי מזון ישירות, וזרועות התזה שמחזרות מים חמים עמוסי שאריות לאורך כל המחזור. השילוב הזה גורם לחלק מהפוסקים להחמיר לגביו יותר מכמעט כל מכשיר אחר, וחלקם ממליצים שלא להשתמש באותה יחידה גם לבשרי וגם לחלבי, אפילו בימים שונים.</p>

<h2>ההליך למי שמתיר</h2>
<ul>
<li>ניקוי יסודי של מסננים, זרועות התזה ואטמי גומי, הסרת כל חלקיק נראה לעין ביד.</li>
...
<h2>החלופה שעוקפת את הבעיה מהשורש</h2>
<p>משפחות רבות עוקפות את המחלוקת באמצעות סלסילות נשלפות, אחת לבשרי ואחת לחלבי, שנכנסות ויוצאות מאותה מכונה. מכיוון שהמזון אינו נוגע ישירות בדפנות או במסנן המכונה, יש דעות רבניות הרואות בפתרון זה פשוט הרבה יותר מהכשרה חוזרת.</p>

<h2>הבדלים בין קהילות</h2>
<p>המנהגים משתנים מאוד בנושא זה — קהילות ספרדיות ואשכנזיות מסוימות נבדלות בצורה ניכרת ברמת החומרה ספציפית לגבי מדיחי כלים. זהו אחד המקרים שכדאי במיוחד להתייעץ ישירות עם רב הקהילה לפני שמחליטים כיצד לארגן את המטבח, במקום להניח שאותו כלל של הגעלת סירים חל גם כאן.</p>

<h2>שאלות נפוצות</h2>
<p><strong>האם מדיח עם מחזור חיטוי בחום גבוה קל יותר להכשרה באופן אוטומטי?</strong><br>
זה יכול לעזור להגיע מהר יותר לטמפרטורה הנדרשת, אך המחלוקת פחות עוסקת בטמפרטורה ויותר במבנה הפנימי של המכונה ובאופן שבו שאריות המזון זורמות בתוכה.</p>
<p><strong>האם סלסילות פלסטיק של המדיח דורשות הכשרה נפרדת?</strong><br>
חלקי הפלסטיק מקבלים בדרך כלל התייחסות שונה מהחלק הפנימי המתכתי; שאלו את הרב לגבי הדגם הספציפי אם השאלה עולה.</p>
<p><strong>האם שימוש בסלסילות נפרדות פותר את הבעיה לחלוטין בכל הקהילות?</strong><br>
לא באופן אוניברסלי — דעות מחמירות יותר עדיין מעדיפות מכונה נפרדת לחלוטין לכל קטגוריה. כדאי לוודא מה הקריטריון שהקהילה שלכם עוקבת אחריו.</p>

<h2>להמשך קריאה</h2>
<p>לגבי שיטת ההכשרה המשמשת לסירים, מחבתות וסכו"ם, ראו <a href="/articulos/hagala-utensilios-metal">הגעלה: איך מכשירים כלי מתכת</a>. ולגבי התנור, שפועל לפי אותו עיקרון בסיסי דרך חום יבש, ראו <a href="/articulos/kasherizar-horno">איך מכשירים תנור</a>.</p>',
            ],
            'hagala-utensilios-metal' => [
...
<h2>העיקרון שמאחורי השיטה</h2>
<p>העיקרון פשוט לזכור: "כבולעו כך פולטו". אם כלי ספג טעם לא כשר (או בשרי/חלבי) באמצעות נוזל רותח, הוא מיטהר באותה הדרך: על ידי טבילה במים רותחים. זהו אותו עיקרון שעומד מאחורי הכשרת <a href="/articulos/kasherizar-horno">תנור</a>, המיושם בשיטה שונה בהתאם לסוג החום שספגה כל משטח.</p>

<h2>ההליך צעד אחר צעד</h2>
<ol>
<li>לנקות את הכלי ביסודיות, ללא חלודה, מזון דבוק או לכלוך מוצק. כל שארית שנשארת חוסמת את המגע הישיר עם המים ופוסלת את התהליך באותה נקודה.</li>
<li>להמתין 24 שעות ללא שימוש בכלי לפני ההגעלה. תקופה זו גורמת לכך שהטעם הספוג נחשב "מקולקל" וקל יותר לפליטה.</li>
<li>להרתיח סיר גדול של מים עד לרתיחה מלאה, בכלי שונה מזה שמכשירים.</li>
<li>לטבול את הכלי במלואו במים הרותחים, כך שכל משטחיו — כולל קצוות ומחילות — יבואו במגע עם המים בטמפרטורה זו.</li>
<li>להוציאו בעזרת כלי שלא היה במגע עם מזון לא כשר, ולשטוף אותו מיד במים קרים.</li>
</ol>

<h2>כלים שהשיטה הזו לא פותרת</h2>
<p>כלים עם ידית מעץ או פלסטיק, או עם חלקים מודבקים בדבק שאינו עמיד במים רותחים, בדרך כלל אינם מתאימים להגעלה ודורשים שיטה אחרת, או שפשוט אינם ניתנים להכשרה. מחבתות אנטי-דביקות (טפלון) גם אינן מוכשרות בדרך כלל בהגעלה, מכיוון שהציפוי ניזוק מהחום ותהליך ההכשרה עצמו היה פוגע במשטח בכל מקרה. לגבי זכוכית וכלי אוכל, הקריטריון שונה: ראו <a href="/articulos/vajilla-para-pesaj">כלים לפסח</a>, חומר אחר חומר.</p>

<h2>שאלות נפוצות</h2>
<p><strong>האם ההגעלה מתאימה לכל כלי שהיה במגע עם מזון לא כשר?</strong><br>
לא תמיד. אם הכלי היה במגע ישיר עם אש (כמו גריל), השיטה הנכונה שונה: ליבון, המחייב חימום המתכת עד להיותה לוהטת או עד שקש הנוגע בה נשרף. ההגעלה מיועדת ספציפית לספיגה על ידי נוזל.</p>
<p><strong>כמה פעמים ניתן להכשיר את אותו כלי?</strong><br>
אין גבול קבוע לשימוש חוזר בשיטה עצמה, כל עוד הכלי במצב תקין. מה שחשוב בכל פעם הוא לכבד את תקופת ה-24 השעות ללא שימוש קודם.</p>
<p><strong>האם צריך רב נוכח כדי לבצע הגעלה בבית?</strong><br>
זה לא חובה עבור ההליך הביתי הרגיל, אך במקרה של ספק לגבי כלי ספציפי כדאי להתייעץ מראש.</p>

<h2>להמשך קריאה</h2>
<p>אם מדובר בתנור או מיקרוגל, למקרים אלה יש כללים משלהם: ראו <a href="/articulos/kasherizar-horno">איך מכשירים תנור</a> ו<a href="/articulos/kasherizar-microondas">איך מכשירים מיקרוגל</a>. לגבי מדיח הכלים, אחד המכשירים השנויים ביותר במחלוקת, ראו <a href="/articulos/kasherizar-lavavajillas">איך מכשירים מדיח כלים</a>.</p>',
            ],
            'vajilla-para-pesaj' => [
                'title' => 'כלים לפסח: כל מה שצריך לדעת',
                'excerpt' => 'בפסח חלים כללים מחמירים יותר מכל השנה לגבי כלי מטבח, בשל איסור החמץ.',
                'content' => '<p>פסח הוא החג עם כללי הכשרות המחמירים ביותר בלוח השנה היהודי, מכיוון שבנוסף לכללי הכשרות הרגילים, מתווסף איסור מוחלט על אכילת או החזקת <a href="/articulos/jametz-pesaj">חמץ</a> (מוצרים מותססים מחמשת מיני הדגן: חיטה, שעורה, שיבולת שועל, שיפון וכוסמין).</p>
...
<h2>למה החמץ משאר השנה הוא הבעיה</h2>
<p>הבעיה היא שהחמץ עשוי היה להיות במגע עם סירים, צלחות וסכו"ם לאורך כל השנה: בכל פעם שבישלו פסטה, אפו לחם או הגישו עוגיות, הכלים האלה ספגו שאריות חמץ. בשאר השנה זו לא בעיה, מכיוון שהחמץ עצמו כשר. אך בפסח, כלים שעלולים "לשחרר" את הטעם הספוג הזה מתנגשים עם האיסור המוחלט של החג.</p>

<h2>האפשרות הפשוטה ביותר: כלים נפרדים</h2>
<p>לכן משפחות רבות בוחרות להחזיק מערכת כלים נפרדת, ייעודית לפסח, המאוחסנת שאר השנה בקופסאות או בארון מיוחד: זוהי האפשרות הפשוטה ביותר, והיא נמנעת מהצורך להכשיר מדי שנה. עם הזמן, משפחות רבות בונות את הכלים הללו בהדרגה, קונות או יורשות פריטים, עד שיש להן מערכת שלמה המוקדשת רק לשמונת הימים האלה בשנה.</p>

<h2>מה ניתן להכשיר, חומר אחר חומר</h2>
<p>למי שאין כלים נפרדים לפסח, ניתן להכשיר כלים מסוימים באמצעות <a href="/articulos/hagala-utensilios-metal">הגעלה</a>, אם כי לא את כולם:</p>
<ul>
<li><strong>מתכת ללא ציפוי</strong> (סירים, סכו"ם): בדרך כלל מתאים להגעלה, לפי אותו הליך המשמש בשאר השנה.</li>
<li><strong>זכוכית</strong>: לפי המנהג, יש הסוברים שדי בשטיפה טובה, ויש הדורשים טבילה; כדאי לבדוק את הקריטריון של הקהילה שלכם.</li>
<li><strong>קרמיקה וחרסינה</strong>: בדרך כלל אינן ניתנות להכשרה לפסח לפי אף דעה, מכיוון שהחומר הנקבובי סופג לצמיתות; יש להשתמש בערכה נפרדת.</li>
<li><strong>פלסטיק וגומי</strong>: רוב הדעות אינן מתירות הכשרתם, אם כי קיימים חריגים נקודתיים בהתאם לשימוש שנעשה בהם.</li>
</ul>

<h2>שאלות נפוצות</h2>
<p><strong>האם צריך לקנות כלים חדשים לפסח כל שנה?</strong><br>
לא, לאחר שהמערכת מורכבת היא משמשת שוב בכל שנה, מאוחסנת בשאר הזמן. צריך רק להחליף פריטים שנשברו או להוסיף חדשים אם המשפחה גדלה.</p>
<p><strong>האם גם מכשירי חשמל צריכים מערכת נפרדת?</strong><br>
תלוי במכשיר. חלקם, כמו טוסטר, בדרך כלל אינם ניתנים להכשרה וכדאי שיהיה אחד ייעודי לפסח; אחרים, כמו התנור, יש להם הליך ספציפי המפורט ב<a href="/articulos/kasherizar-horno">איך מכשירים תנור</a>.</p>
<p><strong>כמה זמן מראש צריך להתחיל להכין את הכלים?</strong><br>
כדאי להתחיל עם מרווח, לפחות שבוע מראש, כדי שיהיה זמן להכשיר בלי חיפזון את הכלים שמתאפשר, ולפתור כל ספק עם הרב או הכשרות המקומית לפני תחילת החג.</p>

<h2>להמשך קריאה</h2>
<p>כדי להבין בדיוק אילו מוצרים צריך להוציא מהמטבח לפני החג, ראו <a href="/articulos/jametz-pesaj">חמץ: מהו וכיצד מסלקים אותו</a>. ולדעת מה לעשות עם הסירים והמחבתות המשמשים יום-יום, ראו <a href="/articulos/hagala-utensilios-metal">איך מכשירים כלי מתכת</a>.</p>',
            ],
            'jametz-pesaj' => [
...
<h2>לא רק לאכול: גם להחזיק אסור</h2>
<p>התורה אוסרת לא רק לאכול חמץ בפסח, אלא גם להחזיק בו, אפילו רק מאוחסן בלי כוונה לאכול אותו. לכן, בשבועות שלפני החג, משפחות יהודיות עורכות ניקיון יסודי של הבית (בדיקת חמץ) כדי לסלק כל שריד של לחם, קמח או מוצרי חמץ מהארונות, מהרכבים, מהתיקים ומכל פינה שאליה הייתה עשויה ליפול פירור. הניקיון הזה מתחיל בדרך כלל כמה ימים מראש, חדר אחר חדר, ומסתיים בלילה שלפני פסח בחיפוש טקסי אחרון.</p>

<h2>מה עושים עם חמץ שאי אפשר לזרוק</h2>
<p>עבור חמץ שאי אפשר או לא כדאי לזרוק, כמו משקאות חריפים יקרים או מוצרים קשים להחלפה, קיימת האפשרות "למכור" אותו באופן סמלי לאדם לא יהודי באמצעות חוזה הנקרא <em>מכירת חמץ</em>, המתואם בדרך כלל על ידי רב הקהילה, לעתים קרובות באינטרנט בשבועות שלפני החג. החמץ הנמכר נשמר סגור ובנפרד במהלך החג, נוכח פיזית בבית אך "נמכר" מבחינה משפטית, ו"נקנה בחזרה" אוטומטית בתום פסח, ללא כל פעולה נוספת מצד הבעלים.</p>

<h2>החיפוש הטקסי והשריפה הסופית</h2>
<p>בלילה שלפני פסח מתבצעת בדיקת חמץ, החיפוש הטקסי אחר חמץ בכל הבית, בדרך כלל עם נר, נוצה וכף עץ. נהוג שלפני תחילת החיפוש, בן משפחה מסתיר בכוונה כמה פירורי לחם עטופים בנייר כדי שהחיפוש לא יסתיים בלי כלום (מנהג נפוץ בקהילות רבות). למחרת בבוקר נשרף מה שנמצא בטקס הנקרא ביעור חמץ, המלווה בהצהרה המבטלת כל שארית שאולי לא נמצאה.</p>

<h2>שאלות נפוצות</h2>
<p><strong>האם שיבולת שועל ושיפון באמת אסורים, או רק חיטה?</strong><br>
כל חמשת מיני הדגן (חיטה, שעורה, שיבולת שועל, שיפון וכוסמין) כלולים באיסור החמץ כשהם מותססים עם מים. אורז ותירס אינם חלק מקבוצה זו, אם כי בקהילות מסוימות (בעיקר אשכנזיות) נמנעים מהם מכוח מנהג נפרד הנקרא קטניות, שונה מאיסור החמץ עצמו.</p>
<p><strong>מה קורה אם מוצא חמץ בבית במהלך פסח?</strong><br>
יש להסירו מיד: לשמור סגור עד תום החג אם כבר נכלל במכירה הסמלית, או לזרוק אם לא.</p>
<p><strong>האם למכירת החמץ יש עלות?</strong><br>
היא נעשית בדרך כלל ללא עלות או בתרומה סמלית לבית הכנסת המתאם אותה; זו אינה מכירה אמיתית מבחינה כלכלית, אלא מנגנון משפטי בתוך ההלכה.</p>

<h2>להמשך קריאה</h2>
<p>כדי להבין מה קורה עם הסירים והצלחות שהיו במגע עם חמץ במהלך השנה, ראו <a href="/articulos/vajilla-para-pesaj">כלים לפסח</a>. ולמידע נוסף על לוח השנה ומה אוכלים בכל חג, ראו <a href="/articulos/calendario-judio-festividades-alimentacion">לוח השנה היהודי והתזונה</a>.</p>',
            ],
            'vino-kosher' => [
...
<h2>חלוקת עבודה מיוחדת: היקבן והיהודי</h2>
<p>בפועל, זה יוצר חלוקת עבודה מיוחדת למדי. מי שמבין ביין הוא היקבן, שבדרך כלל אינו יהודי (הגוי), והוא זה שמנחה מה לעשות בכל שלב: מתי לבצור, איך לתסוס, אילו מיזוגים לעשות. אבל מי שבפועל מזיז את היין, פותח את הברזים ועושה כל מה שכרוך במגע עם המוצר, הוא תמיד יהודי שומר מצוות (היהודי). המומחה מכוון, היהודי מבצע, והכול תחת השגחה רבנית מתמדת בכל שלב בתהליך.</p>
<p>היין נח בסביבות שונות בהתאם לשלב, וחלק ממנו נשמר בחביות אלון, שניתן לעשות בהן שימוש חוזר כשלוש פעמים לפני שהן מאבדות את תכונותיהן הארומטיות.</p>
...
<p>כל חבית חתומה, והחותם הזה אינו פרט שולי: הוא הערובה לכך שאיש מבחוץ לא נגע בתוכן. סיפרו לנו על מקרה שממחיש עד כמה רחוקה הדרישה. בחבית של אלפי ליטרים שמו לב שהחותם חסר בדיוק בנקודה שהייתה אמורה להיות סגורה: היא הייתה פתוחה. הרב מבואנוס איירס נאלץ להגיע לבדוק את המצב באופן אישי, וקבע שהיין נותר ללא השגחה. התוצאה: אלפי הליטרים ההם כבר לא יכלו להימכר ככשרים.</p>

<h2>החריג שפותר את הבעיה לאירועים גדולים</h2>
<p>קיימת גם קטגוריה מיוחדת, <strong>יין מבושל</strong>, שהוא יין שעבר פסטור בטמפרטורה מסוימת. ברגע שיין הופך למבושל, הוא שומר על מעמדו הכשר גם אם לאחר מכן אדם לא יהודי מגיש או נוגע בו. לכן הוא כה שימושי לאירועים, מסעדות וקייטרינג, שבהם אין דרך לשלוט מי אוחז בכל בקבוק. הפירוט המלא של איך פועל חריג זה נמצא ב<a href="/articulos/vino-mevushal">מבושל: יין כשר שניתן להגיש ללא הגבלות</a>.</p>

<h2>איפה מייצרים אותו כיום</h2>
<p>כיום יש יין כשר באיכות טובה כמעט בכל אזורי הגפן בעולם. מנדוסה היא מוקד חשוב בארגנטינה, ויין כשר מיוצר גם בצ\'ילה, צרפת, ספרד, איטליה וכמובן ישראל, המוסמכים על ידי הכשרויות המובילות. איכות היינות הללו השתפרה מאוד בעשורים האחרונים: לפני שנים ליין כשר היה מוניטין של מתיקות ואיכות מוגבלת, אך כיום הוא מתחרה שווה בשווה עם יינות רגילים בטעימות עיוורות.</p>

<h2>שאלות נפוצות</h2>
<p><strong>למה ליין יש כללים כה שונים ממזון מוצק?</strong><br>
זה נובע מהמקור ההיסטורי של ההגבלה: יין שימש באופן ספציפי בטקסי עבודה זרה בעת העתיקה, דבר שלא קרה באותו אופן עם מאכלים אחרים, וחשש ספציפי זה יצר כלל משלו ומחמיר יותר.</p>
<p><strong>האם למיץ ענבים יש את אותן ההגבלות כמו ליין?</strong><br>
כן, מיץ ענבים שלא תסס עוקב אחר אותו קריטריון טיפול כמו היין, בדיוק מכיוון שהוא עלול לתסוס ולהפוך ליין.</p>
<p><strong>איך אני יודע אם לבקבוק יין יש את ההשגחה הנכונה?</strong><br>
על ידי חיפוש חותם של כשרות מוכרת בתווית; ללא חותם זה אין דרך לאשר שכל שרשרת הטיפול היהודי נשמרה.</p>

<h2>להמשך קריאה</h2>
<p>לגבי החריג המאפשר להגיש יין ללא הגבלות על מי נוגע בו, ראו <a href="/articulos/vino-mevushal">יין מבושל</a>. ולגבי משקאות אחרים שבהם מקור היין נכנס גם לתמונה, ראו <a href="/articulos/alcohol-bebidas-espirituosas">אלכוהול ומשקאות חריפים</a>.</p>',
            ],
            'gelatina-kosher' => [
                ...
                'content' => '<p>ג\'לטין מסורתי מופק מהרתחת עצמות, עור ורקמת חיבור של בעלי חיים — בדרך כלל פרות או חזירים — עד להפקת הקולגן. זה מעלה שתי בעיות מבחינת הכשרות: מקור החיה (האם זו חיה כשרה?) ושיטת העיבוד (האם החיה נשחטה לפי דיני ה<a href="/articulos/shejita-sacrificio-kosher">שחיטה</a>?).</p>
...
<h2>המחלוקת המהותית: האם השינוי מבטל את המעמד?</h2>
<p>במשך עשורים, פוסקים שונים התווכחו האם הג\'לטין, לאחר מעבר תהליך כימי כה משמעותי, משנה את מעמדו ההלכתי, מושג הנקרא <em>פנים חדשות</em> (שינוי מהותי מוחלט). דעות מקלות יותר טענו שהתהליך כה רדיקלי — מעצם ועור לאבקה גבישית חסרת טעם, צבע ומרקם שניתן לזהות מהחיה המקורית — עד שהמוצר הסופי כבר אינו נחשב לבשר במובן ההלכתי. עם זאת, רוב הכשרויות המקובלות אינן מקבלות עמדה זו לגבי ג\'לטין ממקור לא כשר, ודורשות שמקור הקולגן יהיה מורשה מלכתחילה.</p>

<h2>החלופות שעוקפות את הבעיה מהשורש</h2>
<p>לכן, כיום רוב המוצרים המוסמכים כשר הדורשים ג\'לטין (ממתקים, קינוחים, כמוסות תרופות, מרשמלו) משתמשים באחת מהחלופות הבאות:</p>
<ul>
<li><strong>ג\'לטין דגים כשר:</strong> מופק ממינים בעלי סנפיר וקשקשת, נמנע מבעיית המקור שיש לג\'לטין ממקור יונקים.</li>
<li><strong>ג\'לטין בקר מבעלי חיים שנשחטו לפי דיני השחיטה:</strong> פותר את הבעיה מהמקור, אם כי הוא בדרך כלל יקר יותר מהחלופה המקובלת.</li>
<li><strong>תחליפים צמחיים</strong> כמו אגר-אגר (מופק מאצות) או פקטין (מפירות), המונעים את המחלוקת לחלוטין מכיוון שאין להם מקור מן החי.</li>
</ul>
<p>כאשר מוצר נושא חותם של כשרות מוכרת, כבר אין צורך לחקור את מקור הג\'לטין: ההכשר מבטיח שנקודה זו כבר נבדקה כחלק מתהליך ההכשר.</p>

<h2>איפה הג\'לטין מופיע מבלי ששמים לב</h2>
<p>מעבר לממתקים וקינוחים ברורים, ג\'לטין מופיע במקומות פחות ברורים: כמוסות תרופות ותוספי תזונה, יוגורטים וקינוחי חלב מסוימים (לצורך המרקם), יינות ובירות (משמש כחומר צלילה בתהליך הסינון) ומוצרי מאפה תעשייתיים מסוימים. תמיד כדאי לבדוק את התווית, לא להניח שמוצר "ללא טעם ג\'לטין" אינו מכיל אותו.</p>

<h2>שאלות נפוצות</h2>
<p><strong>האם ג\'לטין צמחי (אגר-אגר) תמיד כשר?</strong><br>
מבחינת המקור (אצות), כן, אך כמו בכל מוצר כדאי לוודא שהוא לא עובד בציוד משותף עם מרכיבים לא כשרים.</p>
<p><strong>למה למותגי ממתקים כשרים מסוימים יש מרקם שונה מהמקבילים הרגילים?</strong><br>
כי רבים משתמשים בג\'לטין דגים או בתחליפים צמחיים במקום ג\'לטין בקר או חזיר סטנדרטי, מה שיכול לשנות מעט את המרקם הסופי.</p>
<p><strong>האם מוצר המתויג רק כ"ג\'לטין", ללא פרטים נוספים, יכול להיחשב לא כשר?</strong><br>
ללא הכשר גלוי, אין דרך אמינה לדעת; הבטוח ביותר הוא לחפש חותם של כשרות מוכרת.</p>

<h2>להמשך קריאה</h2>
<p>כדי להבין את שיטת השחיטה שקובעת אם בשר או קולגן ממקור מן החי כשרים, ראו <a href="/articulos/shejita-sacrificio-kosher">שחיטה: שיטת השחיטה הכשרה</a>. ולגבי מרכיב מן החי שנוי במחלוקת באותה מידה, ראו <a href="/articulos/queso-kosher-cuajo">גבינה כשרה וקרישה</a>.</p>',
            ],
            'alcohol-bebidas-espirituosas' => [
...
<h2>הנקודות שראויות לתשומת לב</h2>
<ul>
<li><strong>הזדקנות בחביות יין או שרי:</strong> וויסקי ורום מסוימים מתיישנים בחביות שהכילו בעבר יין לא כשר, ומגע זה עלול להשפיע על מעמדם, בדומה למה שקורה עם <a href="/articulos/vino-kosher">חביות יין כשר</a> שניתן לעשות בהן שימוש חוזר רק מספר מוגבל של פעמים.</li>
<li><strong>תוספי טעם וריח:</strong> ליקרים בטעם קרם, שוקולד או פירות כוללים לעתים קרובות מרכיבים (צבעי מאכל, תמציות, מייצבים) הדורשים בדיקה פרטנית.</li>
<li><strong>משקאות על בסיס יין</strong> (כמו וורמוט או ליקרים מסוימים): יורשים את כל מגבלות היין הכשר, כולל הצורך בהשגחה רבנית לאורך כל הייצור.</li>
<li><strong>בירה:</strong> בדרך כלל כשרה בזכות מרכיביה הבסיסיים (מים, שעורה, כשות, שמרים), למעט סוגים עם טעמים מיוחדים או תהליכי סינון עם חומרי צלילה מן החי.</li>
<li><strong>ליקרים על בסיס קרם:</strong> מכיוון שהם מכילים חלב, מעבר לניתוח המרכיבים יש לקחת בחשבון גם את כללי הערבוב עם מאכלים בשריים.</li>
</ul>

<h2>למה וודקה וג\'ין נוטים להיות פשוטים יותר</h2>
<p>משקאות חריפים ניטרליים כמו וודקה או ג\'ין בסיסי מעוררים בדרך כלל פחות שאלות מוויסקי או רום, מכיוון שהם בדרך כלל אינם עוברים יישון בעץ ומרכיביהם ישירים יותר: מים, דגן או תפוחי אדמה שתססו וזוקקו מספר פעמים. ג\'ין הוא מקרה ביניים, מכיוון שנוספים לו צמחי בושם (ערער, הדרים, תבלינים) במהלך הזיקוק, ושם כדאי לבדוק שהתוספים הללו אינם כוללים מרכיבים בעייתיים.</p>

<h2>פסח: החריג שמשנה הכול</h2>
<p>בפסח יש לשים לב במיוחד מכיוון שמשקאות חריפים רבים מיוצרים מדגנים המהווים <a href="/articulos/jametz-pesaj">חמץ</a>, ולכן נדרש הכשר ספציפי "כשר לפסח" בתקופה זו של השנה. הדבר משפיע במיוחד על וויסקי (העשוי משעורה) ועל וודקות דגנים מסוימות, בעוד שמשקאות חריפים המבוססים על תפוחי אדמה או קנה סוכר בדרך כלל בעלי פחות מגבלות נוספות לחג, אם כי כדאי לוודא הכשר ספציפי לפני הרכישה.</p>

<h2>שאלות נפוצות</h2>
<p><strong>האם כל וויסקי ללא הכשר גלוי אוטומטית לא כשר?</strong><br>
לא בהכרח, אך ללא בדיקה אין דרך לאשר אם הוא התיישן בחביות יין לא כשר או מכיל תוספים בעייתיים. בעת ספק, חפשו מותג עם הכשר מוכר.</p>
<p><strong>האם האלכוהול עצמו (האתנול) יכול להיות לא כשר?</strong><br>
לאתנול כמולקולה אין בעיית כשרות; העניין תמיד קשור למקור חומר הגלם שתסס ולתוספים שנוספו לאחר הזיקוק.</p>
<p><strong>האם קוקטיילים המוכנים בבר רגיל יכולים להיחשב כשרים אם כל המרכיבים כשרים?</strong><br>
זה תלוי בשיקול דעתו של כל אדם: מעבר למרכיבים, נכנס גם לתמונה האם הבר משתמש באותו ציוד להכנות עם מרכיבים לא כשרים, נושא דומה לזה המתעורר ב<a href="/articulos/comer-kosher-restaurante">איך לאכול כשר במסעדה לא מוסמכת</a>.</p>

<h2>להמשך קריאה</h2>
<p>כדי להבין למה יין דורש השגחה כה קפדנית, דבר המשפיע גם על ליקרים על בסיס יין, ראו <a href="/articulos/vino-kosher">יין כשר</a>. ולגבי החריג המאפשר להגיש יין ללא הגבלות, ראו <a href="/articulos/vino-mevushal">יין מבושל</a>.</p>',
            ],
            'comer-kosher-restaurante' => [
                ...
                'content' => '<p>לא תמיד יש מסעדה עם הכשר זמינה, במיוחד בנסיעות או במגורים בערים עם תשתית קהילתית מועטה. בכל זאת, קיימות אסטרטגיות להישאר בגדרי הכשרות במסעדות רגילות, ולא כולן אומרות להישאר רעבים.</p>
...
<h2>האפשרויות הבטוחות ביותר, מהמחמירה לגמישה ביותר</h2>
<ul>
<li><strong>משקאות בבקבוקים אטומים:</strong> מים, משקאות מוגזים ומיצים באריזתם המקורית בדרך כלל אינם מעוררים שום בעיה, לא משנה איפה נקנו.</li>
<li><strong>פירות וירקות חיים:</strong> ללא בישול או טיפול מורכב, בדרך כלל מהווים את האפשרות הבטוחה ביותר כמעט בכל מקום בעולם.</li>
<li><strong>אפשרויות צמחוניות או טבעוניות:</strong> בהסרת בשר וחלב מהצלחת, הסיכון פוחת משמעותית, אם כי עדיין יש לשאול על מרכיבים נסתרים (מרק בשר במוקפץ ירקות, חמאה במחית, רטבים על בסיס מן החי).</li>
<li><strong>דג עם סנפיר וקשקשת:</strong> במסעדות בישול פשוט, דג על הגריל ללא רטבים יכול להיות אלטרנטיבה סבירה למי שנוקט בגישה גמישה יותר, כל עוד הוא לא מבושל יחד עם פירות ים או בשר לא כשר על אותו ציוד — זה כבר תלוי בשיקול דעתו של כל אדם וקהילה.</li>
</ul>
<p>מה שכמעט אף דעה לא מתירה הוא בשר או עוף ממסעדה לא מוסמכת, לא משנה איך נראית המנה: נכנסים לתמונה גם מקור החיה וגם שיטת השחיטה, דבר שלא ניתן לאמת במבט.</p>

<h2>דוגמה אמיתית לאיך זה נפתר בפועל</h2>
<p>פעם נסענו לחופשה לְמַר דֶל פְּלָטָה עם הילדים עוד קטנים, ובהגיענו דרך שדרות קונסטיטוסיון אשתי נזכרה ששכחה את הביסקוויטים. בחורף, באזור הזה, למצוא לחם או ביסקוויטים כשרים כמעט בלתי אפשרי. מה נתנו לילדים? בבית לא היינו רגילים לאכול חטיפים ארוזים מסוימים, אבל מול הדחיפות פנינו לרשימה של Ajdut Kosher, מדריך מוצרי מדף מאושרים שהכשרות מפרסמת. חיפשנו בין המותגים המורשים ומצאנו ביסקוויטים מסוג טרוויאטה שהיו ברשימה. זה הציל אותנו.</p>
<p>המסקנה: כשנוסעים, כדאי מאוד להחזיק ביד את רשימת המוצרים המאושרים של הכשרות שסומכים עליה. המון מוצרי סופרמרקט רגילים כשרים גם בלי חותם גדול מודפס על האריזה, והיכרות עם הרשימה הזאת פותחת אפשרויות במקום שבו נראה שאין אף אחת. כיום רוב הכשרויות מפרסמות רשימות אלה באינטרנט או באפליקציה, כדאי לשמור אחת בטלפון לפני הנסיעה ולא לחפש רק ברגע הצורך.</p>

<h2>לשאול במטבח: מה באמת עוזר</h2>
<p>אם עומדים לאכול משהו שמוכן במקום, יש שאלות שעוזרות יותר מאחרות. לשאול מלצר "זה כשר?" לרוב לא עוזר אם הוא לא יודע מה המילה אומרת. יעיל יותר לשאול משהו קונקרטי: השמן הזה כבר טיגן משהו אחר קודם?, המחבת משמשת גם לבשר?, יש חמאה או שמנת בהכנה? ככל שהשאלה ספציפית יותר, כך התשובה אמינה יותר.</p>

<h2>רמות החומרה השונות, ולמה הן משתנות כל כך</h2>
<p>לכל אדם ולכל קהילה סף שונה לגבי מה שנחשב מקובל מחוץ למסעדה מוסמכת. משפחות מסוימות אוכלות רק מוצרים ארוזים וחתומים מהמפעל, ללא יוצא מן הכלל. אחרות מקבלות הכנות פשוטות מסוימות (סלט, תה) במסעדות רגילות, אך לא מנות מורכבות. אין תשובה אחת נכונה: זה תלוי במנהג המשפחתי וברב שכל אחד עוקב אחריו. בעת ספק במקרה ספציפי, עדיף לשאול לפני הנסיעה, לא לאלתר במקום.</p>

<h2>שאלות נפוצות</h2>
<p><strong>האם מסעדה טבעונית מקובלת אוטומטית?</strong><br>
לא בהכרח. העדר מרכיבים מן החי אינו פותר הכל: הציוד המשותף ושאלת בישול עכו"ם (מזון שבושל כולו על ידי מי שאינו יהודי) עדיין רלוונטיים לפי הדעה שעוקבים אחריה. אנו מפתחים זאת ב<a href="/articulos/kashrut-y-veganismo">כשרות וטבעונות</a>.</p>
<p><strong>מה עושים אם נוסעים לעיר ללא שום קהילה יהודית?</strong><br>
להעדיף מה שארוז וחתום (עם הכשר גלוי) שהבאתם או מצאתם בסופרמרקט, בתוספת פירות וירקות חיים. נוסעים רבים שומרים מלאי מוצרים לא מתכלים מוכשרים למקרים אלה.</p>
<p><strong>האם אפליקציות משלוחים מציינות אם מקום כשר?</strong><br>
לחלק מהכשרויות יש אפליקציות משלהן או רשימות אינטרנט של מסעדות מוסמכות באזור, שבדרך כלל אמינות יותר מלסמוך על תיאור מקום באפליקציית משלוחים כללית.</p>

<h2>להמשך קריאה</h2>
<p>כדי להבין מה הופך מקום למוסמך באמת, ראו <a href="/articulos/simbolos-certificacion-kosher">סמלי הכשר</a>. ואם המטרה היא להקים מטבח משלכם כדי להיות פחות תלויים באכילה בחוץ, ראו <a href="/articulos/armar-cocina-kosher">איך מקימים מטבח כשר מאפס</a>.</p>',
            ],
            'simbolos-certificacion-kosher' => [
                ...
                'content' => '<p>כשמוצר עובר את תהליך ההכשר, גוף הכשרות מאשר שימוש בסמל (הכשר) על האריזה המאפשר זיהוי במבט אחד. קיימות מאות כשרויות בעולם, אך חלקן מוכרות במיוחד בזכות היקפן העולמי, והיכרות איתן חוסכת הרבה זמן בקניות.</p>
...
<h2>הסמלים המוכרים ביותר בעולם</h2>
<ul>
<li><strong>OU (Orthodox Union):</strong> "U" בתוך עיגול. זהו ככל הנראה סמל הכשר המוכר ביותר בעולם, ובסיסו בארצות הברית, מופיע בעשרות אלפי מוצרים.</li>
<li><strong>OK Kosher Certification:</strong> "K" בתוך עיגול, גוף גדול נוסף בארה"ב, חזק במיוחד במוצרים תעשייתיים ותוספים.</li>
<li><strong>Star-K:</strong> כוכב עם "K" במרכזו, ובסיסו בבולטימור.</li>
<li><strong>KSA (Kosher Supervision of America):</strong> כשרות בעלת נוכחות חזקה במוצרים תעשייתיים וטעמים.</li>
<li><strong>בד"ץ:</strong> חותם המשמש בתי דין רבניים שונים בישראל, המזוהה עם סטנדרטים גבוהים במיוחד של חומרה (קיימים כמה בד"צים שונים, לא גוף אחד).</li>
<li><strong>כשרויות מקומיות:</strong> במדינות כמו ארגנטינה, ברזיל או מקסיקו קיימות כשרויות קהילתיות מקומיות (כמו ה-Va\'ad Hakashrut של כל קהילה) עם חותמות משלהן, המוכרות בדרך כלל רק בתוך אותה קהילה או מדינה.</li>
</ul>

<h2>האותיות שמלוות את הסמל</h2>
<p>מלבד הסמל, תוויות רבות כוללות אות נוספת: "D" (חלבי), "M" (בשרי), "Pareve" (פרווה) או "DE" (ציוד חלבי, מיוצר על ציוד חלבי אך ללא מרכיבים חלביים ישירים). ההבחנה האחרונה הזו חשובה: מוצר "DE" אינו מתאים לאכילה מיד לאחר בשר, גם אם אינו מכיל חלב כמרכיב. הכרת סמלים אלה מאיצה מאוד את הקנייה, במיוחד בנסיעה למדינות שבהן לא שולטים בשפה המקומית.</p>

<h2>הכשר אינו הליך חד-פעמי: זו השגחה מתמדת</h2>
...
<h2>למה קהילות מסוימות מקבלות רק חותמות מסוימות</h2>
<p>לא כל רב או קהילה מקבלים את אותם הכשרים. חלק מהקריטריונים גמישים יותר וסומכים על מגוון רחב של כשרויות מוכרות; אחרים, במיוחד בקהילות מחמירות יותר, סומכים רק על מספר מצומצם של חותמות שאת הסטנדרטים שלהן הם מכירים לעומק. לא נדיר לראות "רשימות הכשרים מהימנים" שכל קהילה מפרסמת עבור חבריה. בעת ספק אם חותם מסוים מקובל, הכי פשוט לשאול ישירות את רב הקהילה.</p>

<h2>שאלות נפוצות</h2>
<p><strong>האם מוצר ללא שום סמל יכול להיות כשר בכל זאת?</strong><br>
מבחינה טכנית כן, אם כל מרכיביו כשרים ולא היה מגע עם ציוד לא כשר, אך ללא הכשר אין דרך לאמת זאת מבחוץ. בדיוק בשביל זה קיים ההכשר.</p>
<p><strong>האם כל סמל עם "K" אמין?</strong><br>
לא. בניגוד ל-"OU" או "OK", האות "K" בלבד אינה רשומה כסימן מסחרי על ידי אף גוף ספציפי, כך שכל יצרן יכול להדפיס אותה מבלי שזה יעיד על השגחה אמיתית. כדאי לחשוד ב-"K" בודדת ללא גוף מזוהה מאחוריה.</p>
<p><strong>האם הסמלים אומרים אותו דבר בכל המדינות?</strong><br>
עיצוב הסמל בדרך כלל עקבי מכיוון שהוא רשום כסימן מסחרי על ידי הכשרות, אך רמת האמון שכל קהילה נותנת לו משתנה לפי המדינה והזרם הדתי.</p>

<h2>להמשך קריאה</h2>
<p>כדי להבין את ההבדל בין "D", "M" ו-"Pareve" בפירוט, ראו <a href="/articulos/que-significa-pareve">מה זה פרווה</a>. ואם תרצו לקרוא תווית מלאה מעבר לסמל, ראו <a href="/articulos/como-leer-etiqueta-kosher">איך לקרוא תווית של מוצר כשר</a>.</p>',
            ],
            'que-significa-pareve' => [
...
<p>בנוסף, הבשר חייב לעבור תהליך ניקוי במלח (כשרות) להוצאת הדם, מכיוון שהתורה אוסרת אכילת דם. זה נעשה על ידי השריית הבשר במים, מליחתו והשהייתו לפני שטיפה נוספת — תהליך המתבצע כיום בדרך כלל על ידי האטליז או בית המטבחיים המוסמך עצמו לפני שהמוצר מגיע לצרכן.</p>',
            ...
            'glatt-kosher' => [
                ...
                'content' => '<p>"גלאט" פירושו "חלק" ביידיש, ומקורו התייחס באופן ספציפי למצב הריאות של בעל חיים לאחר ה<a href="/articulos/shejita-sacrificio-kosher">שחיטה</a>: אם הריאות לא הציגו כל הידבקות (סירכה), בעל החיים נחשב "גלאט", הרמה הגבוהה ביותר של ודאות שהבשר כשר ללא ספק.</p>
...
<h2>המקור הטכני: ריאות בעל החיים</h2>
<p>במהלך הבדיקה שלאחר השחיטה, אחד השלבים המרכזיים הוא בדיקת ריאות בעל החיים לאיתור הידבקויות (סירכות), שעלולות להעיד על מחלה או ניקוב שיפסלו את בעל החיים ככשר. כאשר הריאה נראית חלקה לחלוטין, ללא כל הידבקות, בעל החיים מסווג כ"גלאט". אם יש בה הידבקויות קלות שבודק מנוסה סבור שניתן להסירן מבלי להשאיר ניקוב, בעל החיים עדיין עשוי להיחשב כשר לפי הקריטריון הרגיל, אך לא כ"גלאט".</p>

<h2>איך זה עבר ממונח טכני לסימן חומרה כללי</h2>
<p>עם הזמן, במיוחד בקהילות אשכנזיות בארצות הברית, המונח "גלאט כשר" התרחב באופן עממי לתיאור סטנדרט כללי של חומרה רבה יותר לאורך כל שרשרת הייצור של מאכל, לא רק בבדיקת הריאות. כיום נפוץ לראות "גלאט כשר" על תוויות מסעדות ומוצרים כדי לציין שהם עומדים בקריטריונים המחמירים ביותר האפשריים, אפילו בהקשרים שבהם המונח הטכני המקורי (ריאות בעל החיים) כלל אינו רלוונטי.</p>

<h2>האם כשר רגיל "פחות תקף"?</h2>
<p>חשוב להדגיש שמוצר "כשר" ללא התווית "גלאט" אינו פחות תקף הלכתית: הוא פשוט עוקב אחר סטנדרט הכשר שונה, המקובל בדרך כלל על ידי הרוב המכריע של הקהילות והפוסקים. הבחירה בין כשר רגיל לגלאט כשר תלויה בדרך כלל במנהג המשפחתי או הקהילתי, יותר מאשר בהבדל אובייקטיבי בתוקף. משפחות רבות שלא נוהגות גלאט ביום-יום בוחרות בו בכל זאת לאירועים מיוחדים, כמו חתונה או חג חשוב.</p>
<p>במקרה של עופות ודגים, מושג ה"גלאט" טכנית אינו חל באותו אופן, מכיוון שעופות אינם עוברים אותו סוג של בדיקת ריאות, אם כי בעגה היומיומית הוא משמש לעתים לציון רמת השגחה קפדנית יותר באופן כללי.</p>

<h2>שאלות נפוצות</h2>
<p><strong>האם כל בשר גלאט כשר יקר יותר?</strong><br>
בדרך כלל כן, מכיוון שתהליך המיון קפדני יותר ואחוז גבוה יותר של בעלי חיים נפסל, מה שמצמצם את ההיצע הזמין ביחס לביקוש.</p>
<p><strong>האם מסעדה שאומרת "כשר" בלי לציין "גלאט" אינה כנה?</strong><br>
לא, היא פשוט מדויקת: היא עוקבת אחר הקריטריון הכשר הרגיל, התקף לחלוטין עבור רוב הקהילות המכריע.</p>
<p><strong>האם "גלאט" מבטיח שגם כללים אחרים, כמו בישול עכו"ם, נשמרו?</strong><br>
לא באופן אוטומטי. "גלאט" מתייחס באופן ספציפי לרמת בדיקת הבשר; כללים אחרים כמו <a href="/articulos/bishul-akum">בישול עכו"ם</a> נבדקים בנפרד כחלק מתהליך ההכשר הכללי.</p>

<h2>להמשך קריאה</h2>
<p>כדי להבין את התהליך המלא מאחורי בשר כשר, מהשחיטה ועד הבדיקה, ראו <a href="/articulos/shejita-sacrificio-kosher">שחיטה: שיטת השחיטה הכשרה</a>. וכדי לזהות את החותמות שמאשרות את כל זה בתווית, ראו <a href="/articulos/simbolos-certificacion-kosher">סמלי הכשר</a>.</p>',
            ],
            'como-leer-etiqueta-kosher' => [
                'title' => 'איך לקרוא תווית של מוצר כשר',
                'excerpt' => 'מעבר לסמל ההכשר, תוויות כשרות מכילות מידע מרכזי כדי לדעת אם מוצר מתאים לשולחנכם.',
                'content' => '<p>קריאה נכונה של תווית כשרה חורגת מחיפוש סמל ההכשר. ישנם מספר רכיבים שכדאי תמיד לבדוק, ולמידה לקרוא אותם במלואם חוסכת הפתעות בשולחן.</p>
...
<h2>ארבעת הפרטים שכדאי לחפש, לפי סדר</h2>
<ul>
<li><strong>סמל הכשרות:</strong> מזהה איזה גוף השגיח על המוצר. חשוב להכיר כשרויות אמינות (מפורטות ב<a href="/articulos/simbolos-certificacion-kosher">סמלי הכשר</a>), מכיוון שלא כל הסמלים בעולם נמצאים באותה רמת קפדנות.</li>
<li><strong>הקטגוריה:</strong> "Dairy" או "D" (חלבי), "Meat" או "M" (בשרי), "Pareve" (פרווה), או "Fish" (דג, שבמסורות רבות נחשב לקטגוריה נפרדת מבשר). אות זו קובעת עם אילו מאכלים אחרים ניתן לשלב את המוצר.</li>
<li><strong>"כשר לפסח":</strong> ציון נוסף הנדרש במהלך החג, השונה מההכשר הרגיל המשמש בשאר השנה. מוצר יכול להיות כשר כל השנה אך לא מתאים לפסח אם הוא מכיל נגזרת כלשהי מחמשת מיני הדגן.</li>
<li><strong>תאריך או קוד ההכשר:</strong> חלק מהכשרויות כוללות קוד או תאריך כדי לוודא שהחותם עדיין בתוקף, מכיוון שמתכונים ותהליכי ייצור עשויים להשתנות, וההכשר יכול להתבטל מבלי שעיצוב האריזה ישתנה.</li>
</ul>

<h2>קטגוריית "DE": הפרט שהכי מתעלמים ממנו</h2>
<p>מעבר ל"D", "M" ו-"Pareve", תוויות מסוימות כוללות "DE" (ציוד חלבי): פירוש הדבר שהמוצר אינו מכיל מרכיבים חלביים, אך יוצר על אותו ציוד כמו מוצרים חלביים. לצרכים מעשיים, דעות רבות מתייחסות למוצר "DE" בגמישות רבה יותר ממוצר "D" אמיתי, אך לא כמו פרווה טהור. כדאי להבין הבדל זה בפירוט ב<a href="/articulos/que-significa-pareve">מה זה פרווה</a>.</p>

<h2>למה לא כדאי להניח לפי היעדר מידע</h2>
<p>כאשר למוצר אין הכשר נראה לעין אך רשימת המרכיבים נראית פשוטה (למשל, רק מים, מלח וירק), הפיתוי הוא להניח שהוא כשר לפי היעדר מידע. ההמלצה הכללית של רשויות הכשרות היא לא לעשות זאת: תוספים ותהליכים תעשייתיים רבים אינם ברורים במבט ראשון, מאנזימים המשמשים בעיבוד ועד ציוד משותף עם מוצרים אחרים באותו קו ייצור.</p>

<h2>שאלות נפוצות</h2>
<p><strong>האם מוצר ללא קטגוריה מודפסת (D/M/Pareve) הוא תמיד פרווה?</strong><br>
אל תניחו זאת. היעדר אות אינו מאשר דבר בפני עצמו; אם התווית לא מבהירה את הקטגוריה, כדאי לחפש את המוצר ישירות במאגר של הכשרות.</p>
<p><strong>האם אפליקציות לסריקת ברקוד מחליפות את הצורך לבדוק את התווית הפיזית?</strong><br>
הן עוזרות מאוד, אך עדיף להשתמש בהן כתוספת, לא כתחליף מלא, במיוחד עם מוצרים מיובאים או שיוצרו לאחרונה שהמאגר עדיין לא עדכן.</p>
<p><strong>האם בכל המדינות התווית הכשרה חייבת להיות בשפה המקומית?</strong><br>
לא, נפוץ למצוא מוצרים מיובאים עם המידע הכשר רק בשפת המקור (עברית, אנגלית), מה שהופך את הזיהוי הוויזואלי של הסמלים לחשוב יותר מהסתמכות על הטקסט.</p>

<h2>להמשך קריאה</h2>
<p>כדי לזהות במבט את הסמלים הנפוצים ביותר, ראו <a href="/articulos/simbolos-certificacion-kosher">סמלי הכשר</a>. באתר KosherMap ניתן גם לחפש מוצרים לפי שם או ברקוד ולסנן ישירות לפי כשרות, קטגוריה וסוג, כדי לא להסתמך רק על התווית הפיזית.</p>',
            ],
            'bishul-akum' => [
                ...
                'content' => '<p>בישול עכו"ם (פשוטו כמשמעו "בישול של נוכרי") הוא קטגוריה של הלכות רבניות המגבילה את צריכתם של מאכלים מסוימים המבושלים כולם על ידי אדם לא יהודי, גם אם כל המרכיבים כשרים. האיסור נקבע על ידי חכמי התלמוד, בעיקר כדי לעודד לכידות חברתית ולמנוע התבוללות תרבותית בין קהילות.</p>
...
<h2>אילו מאכלים נכללים בקטגוריה זו (ואילו לא)</h2>
<p>הלכה זו אינה חלה על כל המאכלים: היא מוגבלת בדרך כלל למאכלים הנחשבים "ראויים להגשה על שולחן מלך" (חשיבות) ושאינם נאכלים חיים. לכן פירות, ירקות חיים ורוב החטיפים התעשייתיים אינם נכללים בקטגוריה זו. הקריטריון של "חשיבות" סובייקטיבי בחלקו ומשתנה לפי הקהילה: תבשיל מורכב נכלל בבירור, בעוד שירק שפשוט הורתח מעורר יותר ויכוח בין הדעות השונות.</p>

<h2>איך זה נפתר במפעל או מסעדה מוסמכים</h2>
<p>ישנן שתי דרכים נפוצות לפתור את הבעיה בהקשר של ייצור תעשייתי או מסעדות מוסמכות:</p>
<ul>
<li><strong>שיהודי שומר מצוות ישתתף באופן פעיל בתהליך הבישול</strong>, למשל בהדלקת האש או הציוד לפני תחילת תהליך הייצור.</li>
<li><strong>שהשגחה רבנית תאשר</strong> שנציג יהודי היה נוכח בהדלקת ציוד הבישול בכל משמרת ייצור, גם אם שאר התהליך מנוהל לאחר מכן על ידי צוות לא יהודי.</li>
</ul>
...
<h2>למה זה משפיע על מסעדות שאינן כשרות</h2>
<p>זו אחת הסיבות המהותיות לכך שמנה שבושלה במסעדה ללא הכשר מעוררת ספקות גם כאשר כל המרכיבים נראים כשרים: מעבר למקור הבשר או הציוד המשותף, נכנס לתמונה גם מי בפועל הדליק את האש וניהל את הבישול. הנושא מפותח עם דוגמאות קונקרטיות ב<a href="/articulos/comer-kosher-restaurante">איך לאכול כשר במסעדה לא מוסמכת</a>.</p>

<h2>שאלות נפוצות</h2>
<p><strong>האם בישול עכו"ם חל גם בבית, עם עובד ביתי לא יהודי?</strong><br>
כן, העיקרון זהה ללא קשר למקום הבישול; מה שמשתנה הוא הפתרון המעשי, בדרך כלל שבן משפחה יהודי משתתף בהדלקה.</p>
<p><strong>האם תנור חשמלי עם טיימר פותר את בעיית ההדלקה?</strong><br>
זה תלוי בדעה ההלכתית שעוקבים אחריה; יש המקבלים זאת כסוג של "השתתפות" של הבעלים היהודי, ויש הדורשים פעולה ישירה יותר. בעת ספק, התייעצו עם רב הקהילה.</p>
<p><strong>האם לבישול עכו"ם יש קשר להכשרת כלים?</strong><br>
אלה קטגוריות נפרדות: בישול עכו"ם עוסק במי מבשל, בעוד שהכשרה (כמו <a href="/articulos/hagala-utensilios-metal">הגעלה</a>) עוסקת במה שכלי ספג בעבר.</p>

<h2>להמשך קריאה</h2>
<p>כדי לראות איך עיקרון זה מיושם בפועל כשאוכלים בחוץ, ראו <a href="/articulos/comer-kosher-restaurante">איך לאכול כשר במסעדה לא מוסמכת</a>. ולגבי קטגוריה נוספת שבה חשוב מאוד מי מטפל במוצר, ראו <a href="/articulos/vino-kosher">יין כשר</a>.</p>',
            ],
            'vino-mevushal' => [
                ...
                'content' => '<p>כפי שראינו בדיון על <a href="/articulos/vino-kosher">יין כשר</a>, הכלל הכללי דורש שרק יהודים שומרי מצוות יטפלו ביין מהייצור ועד ההגשה. יין מבושל הוא חריג מעשי לכלל זה: לאחר שהיין עובר תהליך חימום בטמפרטורה מינימלית ספציפית, הוא שומר על מעמדו הכשר ללא קשר למי שיגיש אותו לאחר מכן.</p>
...
<h2>למה החום משנה הכול</h2>
<p>קטגוריה זו קיימת הודות לעיקרון הלכתי לפיו יין שעבר שינוי באמצעות חום מאבד את ה"כבוד" הטקסי שהניע במקור את ההגבלה, מכיוון שהיסטורית החשש התמקד בשימוש ביין בטקסי עבודה זרה — דבר שיין מבושל אינו מתאים לו בהקשר זה. משאבד מעמד זה, כבר לא משנה מי נוגע בו או מגיש אותו לאחר מכן: הוא יכול לעבור דרך ידיים לא יהודיות מבלי לאבד את כשרותו.</p>

<h2>היכן משתמשים בו הכי הרבה</h2>
<p>יין מבושל פופולרי מאוד עבור:</p>
<ul>
<li><strong>קייטרינג ואירועים:</strong> חתונות, בר/בת מצווה וקבלות פנים שבהם צוות ההגשה אינו בהכרח יהודי.</li>
<li><strong>מסעדות כשרות הפתוחות לציבור הרחב:</strong> מאפשר לכל מלצר להגיש את היין ללא השגחה מיוחדת בכל שולחן.</li>
<li><strong>חברות תעופה ובתי מלון</strong> המציעים אפשרויות כשרות, שבהם יהיה בלתי אפשרי להבטיח שרק צוות יהודי נוגע בכל בקבוק.</li>
<li><strong>בתי כנסת ואירועים קהילתיים גדולים</strong>, שבהם היין עובר בין ידיים רבות בזמן קידוש.</li>
</ul>

<h2>איך הוא מפוסטר מבלי לפגוע בטעם</h2>
<p>במשך זמן רב, הרתחת היין בשיטה המסורתית פגעה בטעם באופן משמעותי, ולמבושל היה מוניטין של איכות נמוכה יותר. כיום קיימות טכניקות מודרניות של פסטור מהיר, שבהן היין מחומם לטמפרטורה המינימלית הנדרשת למשך שניות ספורות בלבד ומקורר מיד, דבר שהיה קשה בהרבה להשיג בעבר מבלי לפגוע בטעם. הדבר הרחיב מאוד את היצע יינות המבושל הפרימיום הזמינים בשוק, כולל תוויות של יקבים מוכרים שבעבר ייצרו רק יין שאינו מבושל.</p>

<h2>שאלות נפוצות</h2>
<p><strong>האם כל יין כשר הנמכר בסופרמרקטים הוא מבושל?</strong><br>
לא, קיימים גם יינות כשרים שאינם מבושלים בשוק הכללי. כדאי לבדוק את התווית או את אתר הכשרות אם זה רלוונטי לשימושכם (למשל, אם תגישו אותו באירוע עם צוות לא יהודי).</p>
<p><strong>האם למבושל איכות נמוכה יותר מיין כשר רגיל?</strong><br>
כבר לא בהכרח. עם הטכניקות המודרניות של פסטור מהיר, יקבים רבים מייצרים מבושל ברמת פרימיום שאינה ניתנת להבחנה בטעימה עיוורת מהגרסה שאינה מפוסטרת.</p>
<p><strong>האם יין יכול להפוך למבושל אחרי הבקבוק?</strong><br>
לא, תהליך החימום חייב להתבצע לפני או במהלך הייצור, בהשגחה, ומצוין בתווית או בכרטיס המוצר של הכשרות.</p>

<h2>להמשך קריאה</h2>
<p>כדי להבין למה יין רגיל דורש השגחה כה קפדנית מלכתחילה, ראו <a href="/articulos/vino-kosher">יין כשר: למה הוא דורש השגחה מיוחדת</a>. הנושא קשור גם ל<a href="/articulos/bishul-akum">בישול עכו"ם</a>, קטגוריה נוספת שבה חשוב מי מטפל במזון.</p>',
            ],
            'tevilat-kelim' => [
...
<h2>אילו כלים זקוקים לטבילה, ואילו לא</h2>
<p>מנהג זה חל בעיקר על כלים הבאים במגע ישיר עם המזון: סירים, מחבתות, סכו"ם, צלחות זכוכית וכוסות. הוא בדרך כלל אינו חל על מכשירי חשמל (כמו טוסטר או בלנדר) ולא על כלי פלסטיק או עץ, אם כי הדעות משתנות לפי מסורת כל קהילה, ולכן מומלץ להתייעץ עם רב לגבי מקרים ספציפיים. הקריטריון הכללי המשמש להבחנה זו דומה לזה הקובע מה זקוק ל<a href="/articulos/hagala-utensilios-metal">הגעלה</a>: ככל שהמגע עם המזון ישיר יותר והחומר עמיד יותר, כך גדל הסיכוי שיידרש טבילה.</p>

<h2>התהליך צעד אחר צעד</h2>
<ol>
<li>לנקות היטב את הכלי, ללא שאריות תוויות, חותמות או דבק שעלולים להפריד בין המים למשטח.</li>
<li>לבדוק שאין שום חומר (שומן, חלודה, שאריות אריזה) הפועל כמחסום.</li>
<li>לטבול לחלוטין במי המקווה, או במקור מים טבעי מתאים, תוך אמירת ברכה (עבור כלים המחייבים זאת לפי המסורת).</li>
<li>לאחר טבילה נכונה, הכלי מוכן לשימוש רגיל, ללא צורך בשלב נוסף.</li>
</ol>

<h2>איפה לעשות זאת בפועל</h2>
<p>במקוואות קהילתיים רבים יש שעות ספציפיות המוקדשות לטבילת כלים, נפרדות מהשימוש הטקסי האישי, כמו גם הוראות מפורטות אילו חומרים דורשים טבילה ואילו לא. לקהילות גדולות יותר יש לעתים אף בריכה נפרדת, המוקדשת אך ורק לשימוש זה, כדי לא לערבב את השעות עם המקווה לשימוש טקסי אישי.</p>

<h2>שאלות נפוצות</h2>
<p><strong>האם כלי יד שנייה זקוק לטבילה כמו כלי חדש?</strong><br>
כן, אם יוצר או נמכר במקור על ידי גורם לא יהודי, המנהג חל ללא קשר לכך שהכלי חדש או משומש.</p>
<p><strong>מה עושים אם קונים כלי ואין מקווה בקרבת מקום?</strong><br>
ניתן להשתמש בכל מקור מים טבעי העומד בדרישות ההלכתיות (נהר, ים), אם כי בפועל רוב האנשים פונים למקווה הקהילתי הקרוב ביותר עם שעות מתאימות.</p>
<p><strong>האם כלים שנקנו מיצרן יהודי גם זקוקים לטבילה?</strong><br>
בדרך כלל לא; המנהג מתמקד באופן ספציפי בכלים ממקור לא יהודי.</p>

<h2>להמשך קריאה</h2>
<p>לצעדים מעשיים נוספים בציוד מטבח מאפס, כולל מנהג זה, ראו <a href="/articulos/armar-cocina-kosher">איך להקים מטבח כשר מאפס</a>. ולשיטה המשמשת לטהר כלים שספגו טעם לא כשר, ראו <a href="/articulos/hagala-utensilios-metal">הגעלה: איך מכשירים כלי מתכת</a>.</p>',
            ],
            'armar-cocina-kosher' => [
...
<li><strong>הפרדת משטחי עבודה:</strong> קרשי חיתוך, מגבות מטבח וספוגים חייבים גם הם להתחלק לפי קטגוריה, רצוי מאוחסנים במקומות שונים במטבח כדי למנוע ערבוב בטעות.</li>
...
<li><strong>קניית מוצרים מוסמכים:</strong> לבדוק את סמל ההכשר בכל קנייה, עד שזה הופך להרגל אוטומטי שאין צורך לחשוב עליו.</li>
<li><strong>תיאום עם רב:</strong> במיוחד להכשרת פריטים שכבר היו במטבח לפני תחילת תהליך זה, ולפתור ספקות נקודתיים לגבי חומרים או כלים ספציפיים.</li>
<li><strong>הוספת טבילת כלים:</strong> כלים חדשים ממתכת או זכוכית שנקנו מיצרן לא יהודי זקוקים לטבילה טקסית לפני השימוש הראשון.</li>
</ul>

<h2>ללכת בהדרגה: הסדר שהכי מקל על המעבר</h2>
<p>אסטרטגיה נפוצה מאוד בקרב מתחילים היא לשלב את ההפרדה בהדרגה: תחילה כלי השימוש היומיומי (סירים, מחבתות, סכו"ם), לאחר מכן כלי השולחן, ולבסוף המכשירים החשמליים, שבדרך כלל היקרים והמורכבים ביותר לפתרון. אין צורך להחליף את כל המטבח בבת אחת, ומשפחות רבות נמשכות חודשים להשלים את המעבר מבלי שזו תהיה בעיה הלכתית כשלעצמה: מה שחשוב זו הכוונה להמשיך להתקדם, לא המהירות.</p>

<h2>התקציב: איך לחלק את ההשקעה</h2>
<p>הקמת מטבח שלם מאפס עשויה להיראות יקרה אם חושבים עליה כהוצאה חד-פעמית. בפועל, רוב המשפחות מחלקות זאת לרכישות קטנות ומרווחות: ערכת סירים החודש, סכו"ם החודש הבא, וכן הלאה. חנויות ובזארים קהילתיים לרוב מציעים חבילות שתוכננו במיוחד לכך, במחירים נגישים יותר מרכישת הכול בנפרד.</p>

<h2>שאלות נפוצות</h2>
<p><strong>האם צריך לזרוק את כל מה שכבר היה במטבח לפני שמתחילים?</strong><br>
לא בהכרח. כלים רבים ניתן להכשיר בהתאם לחומר (ראו <a href="/articulos/hagala-utensilios-metal">הגעלה</a>); רק מה שלא ניתן להכשיר, כמו רוב הקרמיקה, צריך להחליף.</p>
<p><strong>האם המיקרוגל זקוק לשתי יחידות, אחת לבשרי ואחת לחלבי?</strong><br>
זה לא הכרחי: משפחות רבות משתמשות במיקרוגל אחד המיועד "רק לפרווה", או מכשירות אותו בין שימושים כמתואר ב<a href="/articulos/kasherizar-horno">איך מכשירים תנור</a> (העיקרון דומה).</p>
<p><strong>כמה זמן אורך המעבר בממוצע?</strong><br>
זה משתנה מאוד בהתאם לתקציב ולקצב של כל משפחה, אך זה לא נדיר שזה יימשך בין כמה חודשים לשנה כדי להשלים את כל הצעדים בנחת.</p>

<h2>להמשך קריאה</h2>
<p>לפרטי הטבילה הטקסית של כלים חדשים, ראו <a href="/articulos/tevilat-kelim">טבילת כלים</a>. וכדי להבין את השיטה המשמשת להכשיר את מה שכבר היה בבית, ראו <a href="/articulos/hagala-utensilios-metal">הגעלה: איך מכשירים כלי מתכת</a>.</p>',
            ],
            'certificaciones-kosher-mundo' => [
                ...
                'content' => '<p>למרות שעקרונות היסוד של הכשרות הם אוניברסליים, קיימות מאות גופי הכשר בעולם, ולכל אחד עשויים להיות קריטריונים שונים מעט בנושאים ספציפיים — למשל, איזו רמת השגחה הוא דורש ל<a href="/articulos/bishul-akum">בישול עכו"ם</a>, או כיצד הוא מתייחס לתוספים כימיים מסוימים שמקורם קשה לאתר.</p>
...
<h2>איך ההכשר משתנה לפי האזור</h2>
<ul>
<li><strong>ארצות הברית:</strong> מארחת את הכשרויות התעשייתיות הגדולות ביותר (OU, OK, Star-K, Kof-K), עם תהליכים סטנדרטיים מאוד לייצוא המוני. מוצר המוסמך שם מגיע לרוב לעשרות מדינות כמעט באותה צורה.</li>
<li><strong>ישראל:</strong> הרבנות הראשית מציעה הכשר ממלכתי רשמי, בעוד ארגונים כמו הבד"ץ שומרים על תקנים נוספים הנחשבים מחמירים יותר על ידי קהילות מסוימות, לעתים יוצרים שתי רמות הכשר על אותו מוצר.</li>
<li><strong>אירופה:</strong> כשרויות כמו בית הדין של ערים שונות (לונדון, פריז, ציריך) משגיחות הן על ייצור מקומי והן על ייבוא, מתאימות עצמן לשווקים בעלי היקף תעשייתי קטן יותר מארצות הברית.</li>
<li><strong>אמריקה הלטינית:</strong> לכל קהילה יש בדרך כלל את ה-Va\'ad Hakashrut המקומי שלה (למשל, בבואנוס איירס, סאו פאולו או מקסיקו סיטי), המסמיך הן מוצרים מקומיים והן מסעדות, בדרך כלל עם היקף המוגבל לעיר או למדינה שלה.</li>
</ul>

<h2>למה אין גוף אחד יחיד</h2>
<p>בניגוד לתקני איכות אחרים, אין רשות מרכזית אחת לכשרות ברמה עולמית. כל כשרות מדווחת לשרשרת הרבנים המשגיחים שלה, וההכרה בה נבנית עם הזמן, על בסיס האמון שקהילות ורבנים אחרים נותנים בה. לכן כשרות יכולה להיות מכובדת מאוד בארץ מוצאה וכמעט לא מוכרת במקום אחר, מבלי שזה אומר שהיא פחות רצינית.</p>

<h2>מה לעשות מול חותם שאינך מזהה</h2>
<p>עבור הצרכן, הדבר החשוב ביותר הוא ללמוד לזהות את הכשרויות הפעילות באזורו (מפורט ב<a href="/articulos/simbolos-certificacion-kosher">סמלי הכשר</a>). ובמקרה של ספק לגבי סמל לא מוכר, להתייעץ עם רב הקהילה או לחקור את מוניטין הגוף לפני שסומכים על מוצר. רוב הכשרויות הגדולות מפרסמות רשימות פומביות של מוצרים מוסמכים באתריהן, שימושי במיוחד בקניית מוצרים מיובאים.</p>

<h2>שאלות נפוצות</h2>
<p><strong>האם מוצר המוסמך במדינה אחת מקובל אוטומטית במדינה אחרת?</strong><br>
לא תמיד. זה תלוי בהכרה הדדית בין כשרויות ובקריטריון של כל קהילה; משפחות מסוימות סומכות רק על רשימה מוגבלת של גופים, ללא קשר למקור המוצר.</p>
<p><strong>האם קיימת רשימה גלובלית אחת של כשרויות אמינות?</strong><br>
אין רשימה רשמית אחת, אך ארגונים רבניים אזוריים רבים מפרסמים רשימות משלהם של גופים שהם מכירים בהם, המשמשות כהפניה מעשית.</p>
<p><strong>למה למוצרים מסוימים יש שני או שלושה חותמות שונים?</strong><br>
זה קורה בדרך כלל כשהיצרן רוצה להגיע לשווקים או קהילות עם קריטריוני אמון שונים, ומחפש את אישורם של כמה גופים מוכרים בכל אזור.</p>

<h2>להמשך קריאה</h2>
<p>כדי לזהות במבט את הסמלים הנפוצים ביותר, ראו <a href="/articulos/simbolos-certificacion-kosher">הסמלים הנפוצים ביותר של הכשרות</a>. וכדי להבין את כל המידע שתווית יכולה לשאת מעבר לחותם, ראו <a href="/articulos/como-leer-etiqueta-kosher">איך לקרוא תווית של מוצר כשר</a>.</p>',
            ],
            'queso-kosher-cuajo' => [
                ...
                'content' => '<p>הקיבה (rennet) היא האנזים המשמש באופן מסורתי לקרישת חלב ולהפרדת מי הגבינה בייצור גבינה. הבעיה מנקודת מבט הכשרות היא שהקיבה המסורתית מופקת מקיבת עגלים, וכדי שתהיה כשרה, אותה חיה חייבת להישחט לפי דיני ה<a href="/articulos/shejita-sacrificio-kosher">שחיטה</a> — דבר שכמעט אף פעם לא קורה בתעשיית הגבינות המקובלת.</p>
...
<h2>למה גבינה "רגילה" כמעט אף פעם אינה כשרה לפי היעדר מידע</h2>
<p>לכן, כמעט כל הגבינה ה"רגילה" בשוק, גם אם עשויה רק מחלב וקיבה, אינה כשרה ללא הכשר ספציפי, מכיוון שמקור הקיבה אינו ניתן לאימות בעין. לא הצבע, לא הטעם ולא המרקם של הגבינה משתנים בהתאם לסוג הקיבה המשמשת, כך שאין דרך להבחין ביניהן ללא מידע מהיצרן.</p>

<h2>שלוש החלופות שהיצרנים משתמשים בהן</h2>
<p>האפשרויות שבהן משתמשים יצרני גבינה כשרה כוללות:</p>
<ul>
<li><strong>קיבה מן החי כשרה:</strong> מופקת מבעלי חיים שנשחטו לפי שחיטה ותחת השגחה רבנית לאורך כל השרשרת, מהשחיטה ועד הפקת האנזים.</li>
<li><strong>קיבה מיקרוביאלית:</strong> מיוצרת בתסיסה של פטריות או חיידקים, ללא מקור מן החי, נפוצה יותר ויותר הן בגבינות תעשייתיות והן בכשרות, מכיוון שהיא פותרת את הבעיה גם עבור צרכנים צמחוניים.</li>
<li><strong>קיבה צמחית:</strong> מופקת מצמחים מסוימים (כמו קוצים), המשמשת באופן מסורתי בזנים ספציפיים מסוימים של גבינות ביתיות, בעיקר בחצי האי האיברי.</li>
</ul>

<h2>גבינת ישראל: קריטריון שחורג מהקיבה</h2>
<p>מעבר לקיבה, ישנו גורם רלוונטי נוסף: קהילות רבות דורשות שהגבינה תיוצר תחת השגחה יהודית מתמדת (גבינת ישראל) כדי להיחשב כשרה לחלוטין, קריטריון נוסף לניתוח המרכיבים הפשוט, המתקרב לעיקרון שמאחורי <a href="/articulos/bishul-akum">בישול עכו"ם</a>: לא מספיק שהמרכיבים נכונים, גם מי משגיח על התהליך חשוב.</p>

<h2>שאלות נפוצות</h2>
<p><strong>האם גבינות טבעוניות או "ללא חלב" הן אוטומטית כשרות?</strong><br>
לא בהכרח. גם אם הן נמנעות מבעיית הקיבה מן החי, עדיין צריך לבדוק את שאר המרכיבים ואת הציוד המשמש, כמו בכל מוצר תעשייתי אחר.</p>
<p><strong>האם לגבינה מגוררת ארוזה יש את אותו סיכון כמו לגוש שלם?</strong><br>
כן, ולעתים אף יותר: תהליך הגירור והאריזה עשוי להוסיף מרכיבים נוספים (חומרים נגד הידבקות, חומרים משמרים) הדורשים גם הם אימות.</p>
<p><strong>איך אני יודע אם גבינה משתמשת בקיבה מיקרוביאלית או מן החי ללא הכשר?</strong><br>
ללא הכשר גלוי אין דרך אמינה לדעת מהתווית; לכן קניית גבינה עם חותם מוכר היא הדרך הבטוחה ביותר להימנע מטעויות.</p>

<h2>להמשך קריאה</h2>
<p>כדי להבין את שיטת השחיטה שקובעת אם קיבה מן החי כשרה, ראו <a href="/articulos/shejita-sacrificio-kosher">שחיטה: שיטת השחיטה הכשרה</a>. ולגבי מרכיב מן החי שנוי במחלוקת באותה מידה, ראו <a href="/articulos/gelatina-kosher">ג\'לטין כשר: המחלוקת ההלכתית</a>.</p>',
            ],
            'huevos-kosher' => [
...
<h2>הליך הבדיקה</h2>
<p>ההליך פשוט: בשבירת הביצה, בודקים חזותית את החלמון (ולעתים גם את החלבון) כנגד האור, ומחפשים נקודות אדומות או כתמים. כדאי לשבור כל ביצה לכלי נפרד לפני הוספתה לתערובת גדולה יותר, בדיוק כדי שניתן יהיה לזרוק אותה מבלי לקלקל את שאר ההכנה. אם נמצא דם, הביצה נזרקת לחלוטין; אם החלמון נקי, הביצה ראויה לשימוש רגיל.</p>

<h2>למה זה קורה בחלק מהביצים</h2>
<p>כתם הדם מקורו בדרך כלל בקרע של כלי דם במהלך היווצרות הביצה בתוך התרנגולת, ואין לו שום קשר לכך שהביצה מופרית או לבעיית בריאות כלשהי של העוף. זה נפוץ יותר בביצים של תרנגולות מבוגרות יותר, אם כי זה יכול להופיע בכל ביצה ללא דפוס צפוי, ולכן הבדיקה נעשית תמיד, לא רק "כשזה נראה חשוד".</p>

<h2>עובדות נוספות על ביצים וכשרות</h2>
<ul>
<li>הקליפה והחלבון בדרך כלל אינם מציגים את אותו הסיכון כמו החלמון, אם כי המנהג משתנה לפי הקהילה: יש הבודקים את שני החלקים באותה קפדנות.</li>
<li>ביצים מעופות לא כשרים (כמו יען או עופות דורסים מסוימים) אינן ראויות גם הן, ללא קשר לנוכחות דם, מכיוון שהבעיה המהותית היא מקור העוף, לא הדם עצמו.</li>
<li>מוצרים תעשייתיים המכילים ביצה (כמו פסטה או מיונז) עוברים בדרך כלל תהליך בקרת איכות המזהה אוטומטית ביצים עם דם באמצעות בדיקת אור, אך עדיין דורשים הכשר כדי להבטיח שבקרה זו בוצעה לפי הקריטריונים הנכונים.</li>
</ul>

<h2>שאלות נפוצות</h2>
<p><strong>האם צריך לבדוק גם ביצי שליו או ברווז?</strong><br>
כן, אותו קריטריון חל על ביצים של כל עוף כשר, לא רק על ביצי תרנגולת.</p>
<p><strong>האם ביצה עם כתם קטן מאוד יכולה להינצל על ידי הסרת החלק הזה בלבד?</strong><br>
הדעות משתנות לפי המסורת וגודל הכתם; יש המתירים להסיר רק את הנקודה המושפעת, ויש הדורשים לזרוק את הביצה כולה. בעת ספק, כדאי לעקוב אחר הדעה המחמירה יותר או להתייעץ עם רב.</p>
<p><strong>האם ביצים עם הכשר מגיעות כבר בדוקות מהמפעל?</strong><br>
זה לא מחליף את הבדיקה הביתית: ההכשר מבטיח את מקור העוף ואת התהליך התעשייתי, אך בדיקת החלמון מדם נשארת באחריות המבשל, למעט מוצרים תעשייתיים שכבר עברו בדיקת אור מוסמכת.</p>

<h2>להמשך קריאה</h2>
<p>זהו אחד ההרגלים הפשוטים ביותר לשילוב במטבח כשר יומיומי: בדיקת כל ביצה ברגע שבירתה, לפני ערבובה עם שאר המרכיבים. לצעדים מעשיים נוספים ביום-יום, ראו <a href="/articulos/armar-cocina-kosher">איך להקים מטבח כשר מאפס</a>. ולגבי מאכל פרווה נוסף עם כללי בדיקה משלו, ראו <a href="/articulos/insectos-frutas-verduras">חרקים בפירות וירקות</a>.</p>',
            ],
            'pescado-kosher-aletas-escamas' => [
...
<h2>מה אינו נכלל בכשרות</h2>
<ul>
<li><strong>כל פירות הים</strong> (שרימפס, לובסטר, סרטנים, צדפות, אוסטרות): חסרים גם סנפירים וגם קשקשים לפי כל קריטריון.</li>
<li><strong>תמנון וקלמארי:</strong> גם הם אינם עומדים בקריטריון, מכיוון שאין להם סנפירים או קשקשים אמיתיים.</li>
<li><strong>כריש ולוטה:</strong> חסרים קשקשים אמיתיים לפי רוב הדעות ההלכתיות, אם כי הנושא שנוי במחלוקת במשך שנים בין פוסקים שונים.</li>
<li><strong>צלופח:</strong> חסר קשקשים נראים לעין, ואינו נכלל בקריטריון הכשר.</li>
<li><strong>דג חרב:</strong> מעמדו שנוי במחלוקת היסטורית בין פוסקים שונים, ולא כל כשרות מתייחסת אליו באותו אופן.</li>
</ul>

<h2>למה דג כשר קל יותר להכנה מבשר</h2>
<p>הבדל חשוב לעומת בשר: דג כשר אינו דורש <a href="/articulos/shejita-sacrificio-kosher">שחיטה</a> או תהליך מליחה להוצאת דם, מה שמפשט מאוד את הכנתו. עם זאת, במסורות רבות — במיוחד אשכנזיות — דג נחשב לקטגוריה נפרדת מבשר וחלב, ונמנעים משילובו עם בשר באותה צלחת (אם כי אינו דורש את אותה הפרדה קפדנית של כלים החלה בין בשר לחלב).</p>

<h2>איך לאמת דג בעת הקנייה</h2>
<p>בקניית דג טרי, כדאי לוודא שהוא שומר על העור עם קשקשים נראים לעין, מכיוון שבחלק מתהליכי הפילוט מסירים את העור לחלוטין, מה שמקשה על האימות. לכן דייגים כשרים רבים משאירים חתיכת עור ניתנת לזיהוי בחיתוך, בדרך כלל רצועה ליד הזנב, בדיוק כדי שניתן יהיה לאשר את המין ללא ספק.</p>

<h2>שאלות נפוצות</h2>
<p><strong>האם קוויאר כשר?</strong><br>
זה תלוי בדג המקור: קוויאר של דג חדקן שנוי במחלוקת (בגלל הקשקשים החריגים של החדקן), בעוד ביצי דגים אחרים בעלי סנפירים וקשקשים ברורים מתקבלות בדרך כלל ללא בעיה.</p>
<p><strong>האם נדרש הכשר כדי לקנות דג טרי שלם בדוכן הדגים?</strong><br>
זה לא הכרחי אם אתם עצמכם יכולים לאמת את המין לפי מאפייניו הפיזיים, אם כי עבור מוצרים מעובדים (פילטים ללא עור, שימורים) כדאי לחפש הכשר.</p>
<p><strong>למה נמנעים מלערבב דג עם בשר אם שניהם כשרים בנפרד?</strong><br>
זהו מנהג, לא איסור מאותה קטגוריה כמו בשר וחלב; הוא נוצר מדאגה בריאותית היסטורית שכבר אינה רלוונטית, אך נשמר כמסורת בקהילות רבות.</p>

<h2>להמשך קריאה</h2>
<p>כדי להבין את התהליך שבשר יונקים ועופות באמת זקוק לו, ראו <a href="/articulos/shejita-sacrificio-kosher">שחיטה: שיטת השחיטה הכשרה</a>. ולגבי מרכיב ממקור מן החי עם כללים משלו, ראו <a href="/articulos/gelatina-kosher">ג\'לטין כשר: המחלוקת ההלכתית</a>.</p>',
            ],
            'frutos-secos-contaminacion-cruzada' => [
...
<h2>הסיכונים הנפוצים ביותר</h2>
<ul>
<li><strong>תוספי טעם חלביים:</strong> אגוזים "קלויים בחמאה" או מצופים בשוקולד חלב כבר אינם פרווה ועוברים לקטגוריה החלבית, עם כל הגבלות הערבוב שזה מחייב.</li>
<li><strong>קווים משותפים:</strong> מפעל עשוי לעבד אגוזי פרווה על אותו ציוד שבו מעובדים מאוחר יותר מוצרים חלביים או נגזרות בשר, ויוצרים שאריות לא כשרות ללא ניקוי מוסמך בין האצוות, דבר שאף תווית מרכיבים אינה חושפת בפני עצמה.</li>
<li><strong>שמני בישול:</strong> אגוזים מטוגנים מסוימים משתמשים בשמנים המשותפים עם מוצרים לא כשרים אחרים, מבלי שזה ניכר בטעם הסופי.</li>
<li><strong>ציפויים וזיגוגים:</strong> אגוזים "מסוכרים" או עם ציפוי מתוק עשויים להכיל <a href="/articulos/gelatina-kosher">ג\'לטין</a> או מרכיבים אחרים ממקור מן החי בציפוי.</li>
</ul>

<h2>למה זה נפוץ יותר משנראה</h2>
<p>מפעלי אגוזים רבים מעבדים עשרות זנים ואריזות שונות באותו מתקן, כדי לנצל את אותו ציוד: הקו שהיום קולה שקדים טבעיים אולי עיבד אתמול אצווה מצופה בשוקולד חלב. ללא ניקוי מוסמך בין אצוות (או ללא קווים המוקדשים אך ורק למוצרי פרווה), נותרות שאריות מספיקות כדי שהמוצר כבר לא ייחשב פרווה לפי קריטריון קפדני.</p>

<h2>איך לצמצם את הסיכון בפועל</h2>
<p>אגוז חי ולא מעובד, שנקנה בכמות מספק אמין או בקליפתו המקורית, כמעט לעולם אינו מציג בעיות. אך מוצרים תעשייתיים (תערובות אגוזים, חטיפים בטעמים, חטיפי דגנים) תמיד צריכים להיבדק להכשר, מבלי להניח שהם כשרים אוטומטית רק כי המרכיב העיקרי כשר. זה תקף באותה מידה למוצרים המשווקים כ"טבעיים" או "ללא תוספים": תוויות אלה אינן אומרות דבר על הציוד המשותף.</p>

<h2>שאלות נפוצות</h2>
<p><strong>האם אגוזים בשקית ללא מותג מסוכנים יותר מאלה הארוזים?</strong><br>
הם עלולים להיות, מכיוון שאין דרך לעקוב אחר המקור או התהליך; כדאי לקנות אותם בחנויות אמינות או להעדיף מותגים עם הכשר גלוי.</p>
<p><strong>האם חמאת בוטנים נושאת אותו סיכון?</strong><br>
כן, ולעתים אף יותר, מכיוון שהיא לרוב מכילה שמנים ומייצבים נוספים הדורשים גם הם אימות, מעבר לבוטנים עצמם.</p>
<p><strong>האם אגוזים מונבטים או שהושרו בבית משנים את הניתוח?</strong><br>
לא, אם האגוז המקורי היה חי ולא עובד תעשייתית, השרייתו בבית אינה מכניסה שום סיכון כשרות חדש.</p>

<h2>להמשך קריאה</h2>
<p>לגבי מרכיב נוסף שבו העיבוד התעשייתי הוא מפתח הבעיה, ראו <a href="/articulos/gelatina-kosher">ג\'לטין כשר: המחלוקת ההלכתית</a>. וכדי להבין איך לקרוא את כל המידע הרלוונטי בתווית, ראו <a href="/articulos/como-leer-etiqueta-kosher">איך לקרוא תווית של מוצר כשר</a>.</p>',
            ],
            'kashrut-y-veganismo' => [
...
<h2>מקרים שבהם מוצר טבעוני עשוי שלא להיות כשר</h2>
<ul>
<li><strong>ציוד משותף:</strong> מפעל טבעוני עשוי להשתמש באותו קו ייצור שבו עובד בעבר מוצרי בשר או חלב, ללא הניקוי המוסמך שהכשרות דורשת בין אצוות, בעיה דומה לזו הנראית ב<a href="/articulos/frutos-secos-contaminacion-cruzada">אגוזים וכשרות: סיכוני זיהום צולב</a>.</li>
<li><strong>יין ונגזרותיו:</strong> יין טבעוני (ללא חומרי צלילה ממקור מן החי) עדיין דורש שכל תהליך הייצור יהיה בידי יהודים שומרי מצוות כדי שיהיה כשר, כפי שמוסבר ב<a href="/articulos/vino-kosher">יין כשר</a>.</li>
<li><strong>חרקים:</strong> צבעי מאכל מסוימים (כמו כרמין, ממקור מן החי, מופק מחרק) אסורים בכשרות אך לעתים מתויגים כמתאימים לטבעונים בטעות או לפי תקנים שונים של אישור טבעוני.</li>
<li><strong>בישול עכו"ם:</strong> מאכל טבעוני שבושל כולו על ידי אדם לא יהודי עלול ליפול תחת מגבלה זו, בהתאם לאופן סיווג המוצר (ראו <a href="/articulos/bishul-akum">בישול עכו"ם</a>).</li>
</ul>

<h2>למה ההכשרים הטבעוני והכשר אינם חופפים לחלוטין</h2>
<p>הכשרים טבעוניים מתמקדים כמעט אך ורק במקור המרכיבים: לא בשר, לא חלב, לא ביצה, לא דבש ולא נגזרת מן החי מכל סוג. הכשרות בוחנת גם את זה, אך גם בודקת את התהליך המלא: איזה ציוד שימש, מי היה נוכח בשלבי בישול מסוימים, והאם היה מגע עם מוצרים לא כשרים בשלב כלשהו בשרשרת. אלה מערכות אימות עם מטרות שונות, גם אם הן חופפות במוצרים רבים.</p>

<h2>הכיוון ההפוך: כשר לא תמיד טבעוני</h2>
<p>וגם ההפך נכון: מוצרים כשרים רבים מסוג פרווה הם, למעשה, טבעוניים, מכיוון ש"פרווה" כבר אינו כולל בשר וחלב. אך מוצר יכול להיות כשר ולא טבעוני ללא שום סתירה: יוגורט עם הכשר חלבי, למשל, תקף לחלוטין לכשרות ואינו מתאים לטבעונים.</p>

<h2>שאלות נפוצות</h2>
<p><strong>האם קיים הכשר המשלב את שני הקריטריונים בחותם אחד?</strong><br>
כשרויות מסוימות מציעות ציונים משולבים ("Kosher Pareve" לצד חותם טבעוני מאותו יצרן), אך אלה שני תהליכי אימות נפרדים, לא הליך אחד.</p>
<p><strong>האם מסעדה טבעונית ב-100% זקוקה להכשר נפרד כדי להיות אמינה?</strong><br>
כן, אם היא מבקשת להיחשב כשרה: העובדה שכל המנות טבעוניות אינה פותרת אוטומטית את נושא הציוד או את שאלת מי מבשל.</p>
<p><strong>האם דבש הוא טבעוני או כשר?</strong><br>
דבש הוא כשר (חריג בולט, מכיוון שהוא מגיע מחרק אך ההלכה מתירה אותו), אך הוא אינו טבעוני, מכיוון שרוב האישורים הטבעוניים שוללים כל מוצר ממקור מן החי, כולל חרקים.</p>

<h2>להמשך קריאה</h2>
<p>כדי להבין למה יין דורש השגחה כה מיוחדת, גם כשהוא טבעוני, ראו <a href="/articulos/vino-kosher">יין כשר</a>. ולגבי סיכון הזיהום הצולב במוצרים שנראים פשוטים, ראו <a href="/articulos/frutos-secos-contaminacion-cruzada">אגוזים וכשרות</a>.</p>',
            ],
            'separar-la-jala' => [
...
<h2>מתי מצווה זו חלה</h2>
<p>מצווה זו חלה בעת לישת כמות משמעותית של בצק העשוי מאחד מחמשת מיני הדגן (חיטה, שעורה, שיבולת שועל, שיפון או כוסמין) — הכמות המינימלית המדויקת (בדרך כלל סביב 1.2 ק"ג קמח) משתנה לפי הדעה ההלכתית הננקטת. מתחת לכמות זו, ההפרשה אינה חובה, אם כי מנהגים מסוימים עושים זאת בכל זאת, ללא ברכה.</p>

<h2>התהליך צעד אחר צעד</h2>
<ol>
<li>ללוש את בצק הלחם כרגיל, עד שמגיע לכמות המינימלית הנדרשת.</li>
<li>להפריש חלק קטן (מסורתית בגודל זית או יותר, בהתאם למנהג).</li>
<li>לברך את הברכה המתאימה לפני הפרשת החלק, אם כמות הבצק מגיעה למינימום המחייב זאת.</li>
...
<h2>טקס משפחתי, מעבר למחווה הטכנית</h2>
...
<p>עם הזמן, משפחות רבות הופכות רגע זה למנהג כמעט שבועי, במיוחד באפיית לחם או חלה לשבת: הבנות הגדולות יותר בבית מתפקדות בחישוב כמות הקמח כדי לוודא שמגיעים למינימום, ורגע הפרשת החלק עם הברכה הופך לחלק קבוע משגרת יום שישי.</p>

<h2>שאלות נפוצות</h2>
<p><strong>האם צריך להפריש חלה אם לשים מעט בצק, לשימוש משפחתי קטן?</strong><br>
אם לא מגיעים לכמות המינימלית של קמח, ההפרשה אינה חובה לפי ההלכה, אם כי משפחות מסוימות עושות זאת בכל זאת, ללא ברכה, מתוך מנהג.</p>
<p><strong>האם ניתן להפריש חלה מבצק שאינו מיועד ספציפית ללחם (למשל, למאפים)?</strong><br>
כן, המצווה חלה על כל בצק העשוי מחמשת מיני הדגן המגיע לכמות המינימלית, לא רק ללחם המסורתי.</p>
<p><strong>מה קורה אם שוכחים להפריש חלה לפני האפייה?</strong><br>
ניתן להפריש גם לאחר אפיית הלחם, אם כי עדיף לעשות זאת קודם; התייעצו עם רב אם עולה ספק ספציפי זה.</p>

<h2>להמשך קריאה</h2>
<p>אם תרצו להעמיק, <a href="https://oukosher.org/the-kosher-primer/" target="_blank" rel="noopener">המדריך של Orthodox Union</a> מפתח את הלכות הפרשת חלה עם מקורותיהן, וניתן לעיין בערך <a href="https://he.wikipedia.org/wiki/%D7%97%D7%9C%D7%94_(%D7%9E%D7%90%D7%9B%D7%9C)" target="_blank" rel="noopener">ויקיפדיה על החלה</a> להקשר ההיסטורי ולגרסאות האזוריות של הלחם. לגבי חגים ומנהגי אוכל נוספים בלוח השנה היהודי, ראו <a href="/articulos/calendario-judio-festividades-alimentacion">הלוח השנה היהודי והחגים</a>.</p>',
            ],
            'calendario-judio-festividades-alimentacion' => [
                ...
                'content' => '<p>מלבד כללי הכשרות החלים כל השנה, הלוח השנה היהודי מביא חגים עם מנהגי אוכל משלהם, והכרתם עוזרת להבין למה מוצרים מסוימים באים והולכים מהמדפים בתקופות מסוימות.</p>
...
<h2>סיור חג אחר חג</h2>
<ul>
<li><strong>ראש השנה:</strong> נהוג לאכול תפוח בדבש לסמל שנה מתוקה, ולהימנע ממאכלים מרים או חמוצים על שולחן החג. נהוג גם לאכול רימון, תוך ספירה סמלית של גרעיניו כזכויות המבוקשות לשנה החדשה.</li>
<li><strong>יום כיפור:</strong> יום צום מלא של 25 שעות, ללא אוכל או שתייה, למעט חריגים רפואיים ספציפיים. הסעודה שלפני הצום בדרך כלל עשירה אך פשוטה, תוך הימנעות ממאכלים מלוחים מדי הגורמים לצמא.</li>
<li><strong>סוכות:</strong> נהוג לאכול בסוכה זמנית בחוץ במשך כל שבוע החג, המשחזרת את הדיור הזמני ביציאת מצרים.</li>
<li><strong>חנוכה:</strong> מסורת אכילת מאכלים מטוגנים בשמן (כמו סופגניות ולביבות) לזכר נס השמן שנמשך שמונה ימים.</li>
<li><strong>פורים:</strong> מכינים אוזני המן, מאפים משולשים ממולאים, ונהוג לחלוק משלוחי מנות עם חברים ומשפחה, בנוסף לסעודה חגיגית אחר הצהריים.</li>
<li><strong>פסח:</strong> החג עם מירב ההגבלות התזונתיות, המתמקד באיסור <a href="/articulos/jametz-pesaj">החמץ</a>, כאשר המצה היא המאכל המרכזי לכל השבוע.</li>
<li><strong>שבועות:</strong> מנהג אכילת מאכלים חלביים, עם מאכלים כמו עוגת גבינה ובלינצ\'ס (חביתיות ממולאות גבינה) בחזית, לזכר מתן תורה.</li>
</ul>

<h2>למה זה משפיע על מה שרואים במדפים</h2>
<p>לכן מוצרים כמו מצה, סופגניות או יין כשר לפסח מופיעים בזמינות רבה בהרבה יותר במדפים ובחנויות ממש לפני כל חג, ולעתים קרובות נעלמים לחלוטין בשאר השנה. עבור מי שלא מכיר את הלוח השנה היהודי, זה יכול להיראות בלתי צפוי; במציאות זה עוקב אחר מחזור שנתי צפוי למדי ברגע שמכירים את התאריכים.</p>

<h2>הלוח הירחי: למה התאריכים "זזים"</h2>
<p>הלוח השנה היהודי הוא ירחי-שמשי, מה שגורם לחגים ליפול בתאריכים שונים בלוח הגרגוריאני בכל שנה, אם כי תמיד באותה עונה (פסח תמיד באביב חצי הכדור הצפוני, למשל). כדאי לבדוק את הלוח השנה היהודי הספציפי של כל שנה במקום לשנן תאריך קבוע.</p>

<h2>שאלות נפוצות</h2>
<p><strong>לכל החגים הללו יש את אותה רמת הגבלה תזונתית כמו פסח?</strong><br>
לא, פסח הוא המחמיר ביותר מבחינת מה שניתן ואי אפשר לאכול או להחזיק. לשאר יש מנהגי אוכל ספציפיים, אך לא אותו איסור מוחלט על מוצרים מסוימים.</p>
<p><strong>האם יש חגים שבהם ניתן לאכול חמץ גם קרוב לפסח?</strong><br>
כן, מחוץ לתקופה הספציפית של פסח אין הגבלת חמץ; האיסור חל רק במהלך ימי חג זה.</p>
<p><strong>למה לדג או לבשר אין חג הקשור אליהם כמו מוצרי חלב בשבועות?</strong><br>
אין סיבה אחת יחידה; המנהג לאכול מוצרי חלב בשבועות פשוט יש לו שורשים היסטוריים וסמליים ספציפיים שלא שוכפלו באותו אופן עם מאכלים אחרים בחגים אחרים.</p>

<h2>להמשך קריאה</h2>
<p>כדי להעמיק בחג עם מירב הכללים התזונתיים בשנה, ראו <a href="/articulos/jametz-pesaj">חמץ: מהו וכיצד מסלקים אותו לפני פסח</a>. ולגבי הכלים שמשפחות רבות שומרות ספציפית לתקופה זו, ראו <a href="/articulos/vajilla-para-pesaj">כלים לפסח</a>.</p>',
            ],
            'errores-comunes-empezar-comer-kosher' => [
                ...
                'content' => '<p>תחילת קיום דיאטה כשרה היא תהליך שלוקח זמן, וטבעי לטעות בהתחלה. נסקור את הנפוצות ביותר כדי שיהיה קל יותר להימנע מהן מההתחלה.</p>
...
<ul>
<li><strong>הנחה ש"טבעי" או "ללא חומרים משמרים" משמעו כשר:</strong> השיווק של מוצר אינו קשור ישירות למעמדו ההכשרי. תמיד יש לחפש הכשר, לא משנה כמה פשוטה נראית רשימת המרכיבים.</li>
<li><strong>אי בדיקת מוצרים שנראים פרווה באופן ברור:</strong> חטיפים, מאפים וממתקים מכילים לעתים מרכיבים חלביים או <a href="/articulos/gelatina-kosher">ג\'לטין</a> שאינם ברורים משם המוצר.</li>
<li><strong>ערבוב כלים בשריים וחלביים בהיסח הדעת:</strong> בהתחלה קל לשכוח את ההפרדה; תיוג או שימוש בצבעים שונים מסייע מאוד במהלך המעבר, כפי שמפורט ב<a href="/articulos/armar-cocina-kosher">איך להקים מטבח כשר מאפס</a>.</li>
<li><strong>אי בדיקת ירקות עלים מפני חרקים:</strong> שלב שאנשים רבים החדשים לכשרות אינם מודעים לו כלל, והחל בעיקר על ירקות עלים ירוקים.</li>
<li><strong>הסתמכות על הכשרים לא מוכרים או לא ברורים:</strong> לא כל סמל על אריזה הוא הכשר אמיתי; חלקם הם חותמות איכות שאינן קשורות לכשרות. כדאי ללמוד להבחין ביניהם.</li>
<li><strong>אי שאלה:</strong> ספקות רבים נפתרים במהירות באמצעות שאלה לרב הקהילה או למי שמנוסה יותר, במקום לנחש או לברירת מחדל של הקריטריון המחמיר ביותר (או הגמיש ביותר) ליתר ביטחון.</li>
</ul>

<h2>למה כדאי ללכת בהדרגה</h2>
<p>אחת הטעויות השקטות ביותר היא לרצות לפתור הכל בבת אחת: לשפץ את כל המטבח, לשנן את כל הכללים ולהפסיק לאכול בחוץ באותו יום שבו מחליטים להתחיל. בפועל, מי שמצליחים לשמר את השינוי לטווח ארוך מתקדמים בדרך כלל בשלבים, נותנים עדיפות תחילה למה שמבשלים בבית ומשאירים להמשך החלטות מורכבות יותר, כמו אכילה במסעדות או ארגון אירועים.</p>

<h2>שאלות נפוצות</h2>
<p><strong>האם צריך כשרות ייחוס מהיום הראשון?</strong><br>
זה לא הכרחי, אך זה עוזר מאוד: בחירת כשרות אחת או שתיים מוכרות כייחוס מפשטת את החלטות הקנייה מההתחלה, במקום להעריך כל חותם בנפרד.</p>
<p><strong>כמה זמן לוקח להרגיש בנוח עם הכללים הבסיסיים?</strong><br>
זה משתנה מאוד מאדם לאדם, אך רוב האנשים מדווחים על תחושת ביטחון רבה יותר לאחר כמה חודשים של תרגול עקבי, במיוחד ברגע שבדיקת תוויות הופכת להרגל אוטומטי.</p>
<p><strong>האם יש טעות שקשה במיוחד לתקן אחר כך?</strong><br>
ערבוב כלים בשריים וחלביים באופן חוזר עלול לסבך את המטבח יותר לטווח ארוך מטעויות אחרות, מכיוון שהוא עשוי לדרוש הכשרה או החלפת פריטים; לכן כדאי לפתור את ההפרדה הפיזית בהקדם האפשרי.</p>

<h2>להמשך קריאה</h2>
<p>הדבר החשוב ביותר הוא להבין שהמעבר אינו צריך להיות מושלם מהיום הראשון. רוב הקהילות היהודיות מעריכות את תהליך הלמידה ההדרגתי, וישנם משאבים רבים — כולל כשרויות, רבנים וכלים כמו KosherMap — לליווי הדרך הזו. לצעדים הראשונים המעשיים, ראו <a href="/articulos/armar-cocina-kosher">איך להקים מטבח כשר מאפס</a>, ולדעת מה לבדוק בכל תווית, ראו <a href="/articulos/como-leer-etiqueta-kosher">איך לקרוא תווית של מוצר כשר</a>.</p>',
            ],
        ];
    }
...
<h2>Почему духовке нужен настолько радикальный метод</h2>
<p>Внутренняя часть духовки при каждом использовании нагревается до очень высоких температур, поэтому любые впитавшиеся остатки считаются "запечёнными" на гораздо более глубоком уровне, чем в кастрюле. Поэтому более мягкого метода, как агала (погружение в кипящую воду), здесь недостаточно: духовке нужен либун — самоочистка интенсивным сухим жаром, работающая по тому же принципу "как впитало, так и отдаёт", что и для металлической посуды, только через огонь, а не воду.</p>

<h2>Процедура шаг за шагом</h2>
<ol>
<li>Тщательно очистить духовку, удалив всю видимую грязь и остатки пищи, включая уплотнитель дверцы и любой уголок, где скапливается жир.</li>
<li>Не использовать духовку в течение 24 часов перед откошерованием.</li>
<li>Включить духовку на максимально возможную температуру (в идеале с использованием функции самоочистки, если она есть) минимум на час, пока внутренние поверхности не раскалятся.</li>
</ol>

<h2>Решётки, противни и стеклянные поверхности</h2>
<p>Металлические решётки и противни обычно можно откошеровать отдельно путём погружения в кипящую воду (агала), тогда как стеклянные или эмалированные поверхности обычно требуют либуна, так как это более впитывающие материалы. Стекло, в частности, — один из самых спорных материалов в кашруте: одни мнения считают его вообще не впитывающим, другие требуют того же интенсивного жара, что и для металла.</p>

<h2>Духовки, которые не выдерживают либун</h2>
<p>Некоторые современные духовки, особенно с пластиковыми деталями, электронными сенсорными панелями или специальными антипригарными покрытиями, не рассчитаны на температуру, необходимую для либуна, и могут повредиться или даже стать причиной пожара. В таких случаях лучше полностью заменить духовку для нового кошерного старта, чем форсировать метод откошерования, для которого прибор не предназначен.</p>

<h2>Часто задаваемые вопросы</h2>
<p><strong>Считается ли цикл самоочистки сам по себе либуном?</strong><br>
По большинству мнений — да, поскольку он достигает нужной температуры, но стоит убедиться, что цикл охватывает все внутренние поверхности, включая дверцу.</p>
<p><strong>Нужно ли откошеровывать духовку каждый раз, когда в ней случайно готовили что-то некошерное?</strong><br>
Если это был единичный случай, самый безопасный путь — проконсультироваться с раввином о конкретной ситуации, поскольку ответ может зависеть от продукта, температуры и времени нахождения внутри.</p>
<p><strong>Можно ли откошеровать духовку сразу для мясного и молочного использования?</strong><br>
Многие семьи предпочитают сразу закрепить за духовкой одну категорию или использовать отдельные противни и вкладыши для каждого использования, вместо повторного откошерования.</p>

<h2>Читать далее</h2>
<p>Про микроволновую печь, которая использует другой метод на основе пара вместо сухого жара, см. <a href="/articulos/kasherizar-microondas">как откошеровать микроволновую печь</a>. Про посудомоечную машину, один из самых спорных приборов среди раввинских авторитетов, см. <a href="/articulos/kasherizar-lavavajillas">как откошеровать посудомоечную машину</a>.</p>',
            ],
            'kasherizar-microondas' => [
...
<h2>Почему она вызывает столько споров среди раввинских авторитетов</h2>
<p>В отличие от духовки или набора кастрюль, у посудомоечной машины десятки скрытых уголков, фильтр, напрямую удерживающий частицы пищи, и разбрызгивающие рычаги, циркулирующие горячей водой с остатками пищи на протяжении всего цикла. Это сочетание заставляет некоторых авторитетов относиться к ней строже, чем почти к любому другому прибору, а некоторые вообще не рекомендуют использовать одну и ту же машину для мясного и молочного, даже в разные дни.</p>

<h2>Процедура для тех, кто это допускает</h2>
<ul>
<li>Тщательная очистка фильтров, разбрызгивающих рычагов и резиновых уплотнителей, с удалением вручную всех видимых частиц.</li>
<li>Неиспользование посудомоечной машины в течение 24 часов перед откошерованием.</li>
<li>Запуск полного пустого цикла при максимально возможной температуре, в идеале с сильным чистящим средством.</li>
...
<h2>Альтернатива, устраняющая проблему в корне</h2>
<p>Многие семьи обходят этот спор, используя съёмные корзины — одну для мясного, другую для молочного, — которые вставляются и вынимаются из одной и той же машины. Поскольку пища никогда не касается напрямую стенок или фильтра машины, некоторые раввинские мнения считают это решение гораздо проще, чем повторное откошерование.</p>

<h2>Различия между общинами</h2>
<p>Обычаи в этом вопросе сильно различаются — некоторые сефардские и ашкеназские общины заметно расходятся именно в строгости в отношении посудомоечных машин. Это один из тех случаев, когда особенно стоит проконсультироваться напрямую с раввином общины, прежде чем решать, как организовать кухню, а не предполагать, что то же правило, что для агалы кастрюль, применимо и здесь.</p>

<h2>Часто задаваемые вопросы</h2>
<p><strong>Посудомоечная машина с циклом дезинфекции при высокой температуре автоматически легче откошеровывается?</strong><br>
Это может помочь быстрее достичь нужной температуры, но спор касается не столько температуры, сколько внутренней структуры машины и того, как в ней циркулируют остатки пищи.</p>
<p><strong>Требуют ли пластиковые корзины посудомоечной машины отдельного откошерования?</strong><br>
Пластиковые детали обычно рассматриваются иначе, чем металлическая внутренняя часть; спросите своего раввина о конкретной модели, если возникнет такой вопрос.</p>
<p><strong>Полностью ли использование отдельных корзин решает вопрос для всех общин?</strong><br>
Не универсально — более строгие мнения всё же предпочитают полностью отдельную машину для каждой категории. Стоит уточнить критерий, которого придерживается ваша община.</p>

<h2>Читать далее</h2>
<p>О методе откошерования, используемом для кастрюль, сковород и столовых приборов, см. <a href="/articulos/hagala-utensilios-metal">агала: как откошеровать металлическую посуду</a>. А о духовке, которая следует той же логике через сухой жар, см. <a href="/articulos/kasherizar-horno">как откошеровать духовку</a>.</p>',
            ],
            'hagala-utensilios-metal' => [
...
<h2>Принцип, лежащий в основе метода</h2>
<p>Принцип прост для запоминания: "как впитала, так и отдаёт". Если посуда впитала некошерный (или мясной/молочный) вкус через кипящую жидкость, она очищается тем же способом: погружением в кипящую воду. Это тот же принцип, что лежит в основе откошерования <a href="/articulos/kasherizar-horno">духовки</a>, применённый другим методом в зависимости от того, какой вид тепла впитала каждая поверхность.</p>

<h2>Процедура шаг за шагом</h2>
<ol>
<li>Тщательно очистить посуду, без следов ржавчины, прилипшей еды или въевшейся грязи. Любой оставшийся остаток блокирует прямой контакт с водой и делает процесс в этом месте недействительным.</li>
<li>Подождать 24 часа без использования посуды перед агалой. Этот период делает впитавшийся вкус "испорченным" и легче выводимым.</li>
<li>Довести большую кастрюлю воды до сильного кипения, в ёмкости, отличной от той, что откошеровывается.</li>
<li>Полностью погрузить посуду в кипящую воду, убедившись, что все её поверхности — включая края и углубления — контактируют с водой при этой температуре.</li>
<li>Извлечь её инструментом, который не контактировал с некошерной едой, и сразу ополоснуть холодной водой.</li>
</ol>

<h2>Посуда, которую этот метод не решает</h2>
<p>Посуда с деревянной или пластиковой ручкой, или с деталями, приклеенными клеем, не выдерживающим кипящую воду, обычно не подходит для агалы и требует другого метода, либо вообще не может быть откошерована. Антипригарные сковороды (тефлон) также обычно не откошеровывают агалой, поскольку покрытие повреждается от тепла, а сам процесс откошерования всё равно испортил бы поверхность. Для стекла и посуды критерий иной: см. <a href="/articulos/vajilla-para-pesaj">посуда для Песаха</a>, материал за материалом.</p>

<h2>Часто задаваемые вопросы</h2>
<p><strong>Работает ли агала для любой посуды, контактировавшей с некошерной едой?</strong><br>
Не всегда. Если посуда контактировала напрямую с огнём (как гриль), правильный метод другой: либун, требующий нагрева металла до раскалённого состояния или пока не загорится соломинка при касании. Агала предназначена конкретно для впитывания через жидкость.</p>
<p><strong>Сколько раз можно откошеровать одну и ту же посуду?</strong><br>
Фиксированного лимита на повторное использование самого метода нет, пока посуда в хорошем состоянии. Что важно каждый раз — соблюдать период в 24 часа без использования до этого.</p>
<p><strong>Нужен ли раввин для проведения агалы дома?</strong><br>
Это не обязательно для обычной домашней процедуры, но в случае сомнений насчёт конкретного предмета стоит проконсультироваться заранее.</p>

<h2>Читать далее</h2>
<p>Если речь о духовке или микроволновке, для этих случаев есть свои правила: см. <a href="/articulos/kasherizar-horno">как откошеровать духовку</a> и <a href="/articulos/kasherizar-microondas">как откошеровать микроволновую печь</a>. О посудомоечной машине, одном из самых спорных приборов, см. <a href="/articulos/kasherizar-lavavajillas">как откошеровать посудомоечную машину</a>.</p>',
            ],
            'vajilla-para-pesaj' => [
                ...
                'content' => '<p>Песах — праздник с самыми строгими пищевыми правилами в еврейском календаре, потому что помимо обычных норм кашрута добавляется полный запрет на употребление или владение <a href="/articulos/jametz-pesaj">хамецом</a> (ферментированными продуктами из пяти видов злаков: пшеницы, ячменя, овса, ржи и спельты).</p>
...
<h2>Почему хамец, остающийся от всего года, — это проблема</h2>
<p>Проблема в том, что хамец мог контактировать с кастрюлями, тарелками и приборами в течение всего года: каждый раз, когда готовили пасту, пекли хлеб или подавали печенье, эта посуда впитывала следы хамеца. В остальное время года это не проблема, поскольку сам хамец кошерен. Но во время Песаха посуда, способная "выделить" этот впитанный вкус, вступает в конфликт с полным запретом праздника.</p>

<h2>Самый простой вариант: отдельная посуда</h2>
<p>Поэтому многие семьи предпочитают иметь отдельный набор посуды, исключительно для Песаха, хранимый остальную часть года в коробках или специальном шкафу: это самый простой вариант, избавляющий от необходимости откошеровывать посуду каждый год. Со временем многие семьи собирают такую посуду постепенно, покупая или наследуя предметы, пока у них не появится полный набор, посвящённый только этим восьми дням в году.</p>

<h2>Что можно откошеровать, материал за материалом</h2>
<p>Те, у кого нет отдельной посуды для Песаха, могут откошеровать некоторые предметы через <a href="/articulos/hagala-utensilios-metal">агалу</a>, хотя не все:</p>
<ul>
<li><strong>Металл без покрытия</strong> (кастрюли, столовые приборы): обычно подходит для агалы, по той же процедуре, что используется в остальное время года.</li>
<li><strong>Стекло</strong>: согласно обычаю, одни считают достаточным тщательное мытьё, другие требуют погружения; стоит уточнить критерий своей общины.</li>
<li><strong>Керамика и фарфор</strong>: как правило, не могут быть откошерованы для Песаха ни по одному мнению, поскольку пористый материал впитывает необратимо; нужно использовать отдельный набор.</li>
<li><strong>Пластик и резина</strong>: большинство мнений не допускает их откошерования, хотя есть точечные исключения в зависимости от того, как они использовались.</li>
</ul>

<h2>Часто задаваемые вопросы</h2>
<p><strong>Нужно ли покупать новую посуду для Песаха каждый год?</strong><br>
Нет, после того как набор собран, он используется год за годом, храня остальное время. Нужно лишь заменять сломанные предметы или добавлять новые, если семья растёт.</p>
<p><strong>Нужен ли отдельный набор и для бытовой техники?</strong><br>
Зависит от прибора. Некоторые, как тостер, обычно не могут быть откошерованы, и стоит иметь отдельный для Песаха; другие, как духовка, имеют особую процедуру, описанную в <a href="/articulos/kasherizar-horno">как откошеровать духовку</a>.</p>
<p><strong>За сколько времени нужно начинать готовить посуду?</strong><br>
Стоит начать с запасом, минимум за неделю, чтобы было время без спешки откошеровать подходящие предметы и решить любые сомнения с раввином или местным сертификатором до начала праздника.</p>

<h2>Читать далее</h2>
<p>Чтобы точно понять, какие продукты нужно убрать из кухни перед праздником, см. <a href="/articulos/jametz-pesaj">хамец: что это и как его устранить</a>. А чтобы узнать, что делать с кастрюлями и сковородами, используемыми ежедневно, см. <a href="/articulos/hagala-utensilios-metal">как откошеровать металлическую посуду</a>.</p>',
            ],
            'jametz-pesaj' => [
...
<h2>Не только есть: владеть тоже запрещено</h2>
<p>Тора запрещает не только есть хамец во время Песаха, но и владеть им, даже просто храня без намерения съесть. Поэтому за недели до праздника еврейские семьи проводят глубокую уборку дома (бдикат хамец), чтобы удалить любые остатки хлеба, муки или продуктов с хамецом из шкафов, машин, сумок и любого уголка, куда могла упасть крошка. Эта уборка обычно начинается за несколько дней, комната за комнатой, и завершается в ночь перед Песахом финальным ритуальным поиском.</p>

<h2>Что делать с хамецом, который нельзя выбросить</h2>
<p>Для хамеца, который нельзя или невыгодно выбросить, например дорогие крепкие напитки или труднозаменяемые продукты, существует возможность символически "продать" его нееврею через контракт, называемый <em>мехират хамец</em>, обычно координируемый раввином общины, часто онлайн за недели до праздника. Проданный хамец хранится закрытым и отдельно во время праздника, физически присутствуя в доме, но юридически "проданный", и автоматически "выкупается обратно" по окончании Песаха без каких-либо дополнительных действий владельца.</p>

<h2>Ритуальный поиск и финальное сожжение</h2>
<p>В ночь перед Песахом проводится бдикат хамец — ритуальный поиск хамеца по всему дому, обычно со свечой, пером и деревянной ложкой. Принято, что перед началом поиска кто-то из членов семьи специально прячет несколько маленьких кусочков хлеба, завёрнутых в бумагу, чтобы поиск не закончился ничем (распространённый обычай во многих общинах). На следующее утро найденное сжигают в ритуале, называемом биур хамец, сопровождаемом декларацией, аннулирующей любые остатки, которые могли остаться необнаруженными.</p>

<h2>Часто задаваемые вопросы</h2>
<p><strong>Действительно ли овёс и рожь запрещены, или только пшеница?</strong><br>
Все пять видов злаков (пшеница, ячмень, овёс, рожь и спельта) включены в запрет хамеца при ферментации с водой. Рис и кукуруза не входят в эту группу, хотя в некоторых общинах (в основном ашкеназских) их избегают из-за отдельного обычая, называемого китниёт, отличного от самого запрета хамеца.</p>
<p><strong>Что делать, если найду хамец дома во время Песаха?</strong><br>
Его нужно немедленно убрать: хранить закрытым до конца праздника, если он уже был включён в символическую продажу, либо выбросить, если нет.</p>
<p><strong>Есть ли стоимость у продажи хамеца?</strong><br>
Обычно это делается бесплатно или за символическое пожертвование синагоге, координирующей процесс; это не настоящая продажа с экономической точки зрения, а юридический механизм внутри галахи.</p>

<h2>Читать далее</h2>
<p>Чтобы понять, что происходит с кастрюлями и тарелками, контактировавшими с хамецом в течение года, см. <a href="/articulos/vajilla-para-pesaj">посуда для Песаха</a>. А подробнее о календаре и о том, что едят на каждый праздник, см. <a href="/articulos/calendario-judio-festividades-alimentacion">еврейский календарь и питание</a>.</p>',
            ],
            'vino-kosher' => [
...
<h2>Особое разделение труда: винодел и иегуди</h2>
<p>На практике это создаёт довольно особое разделение труда. Тот, кто разбирается в вине — это винодел, который обычно не еврей (гой), и именно он указывает, что делать на каждом этапе: когда собирать урожай, как ферментировать, какие купажи делать. Но тот, кто фактически перемещает вино, открывает краны и делает всё, что связано с прикосновением к продукту, — всегда соблюдающий еврей (иегуди). Специалист руководит, иегуди исполняет, и всё это под постоянным раввинским надзором на каждом этапе процесса.</p>
<p>Вино отдыхает в разных условиях в зависимости от этапа, и часть его хранится в дубовых бочках, которые можно использовать повторно примерно три раза, прежде чем они теряют свои ароматические свойства.</p>
...
<p>Каждая бочка опечатана, и эта печать — не мелочь: это гарантия того, что никто посторонний не прикасался к содержимому. Нам рассказали случай, показывающий, насколько далеко заходит это требование. В бочке на тысячи литров заметили, что печати не было именно там, где она должна была стоять: бочка оказалась открытой. Раввину Буэнос-Айреса пришлось лично приехать проверить ситуацию, и он постановил, что это вино осталось без надзора. Результат: те тысячи литров уже нельзя было продавать как кошерные.</p>

<h2>Исключение, решающее проблему для крупных мероприятий</h2>
<p>Существует также особая категория — <strong>вино мевушаль</strong> ("варёное"), пастеризованное при определённой температуре. Как только вино становится мевушаль, оно сохраняет кошерный статус, даже если потом его подаёт или трогает нееврей. Поэтому оно так удобно для мероприятий, ресторанов и кейтеринга, где невозможно проконтролировать, кто берёт каждую бутылку. Полная детализация того, как работает это исключение, в <a href="/articulos/vino-mevushal">мевушаль: кошерное вино, которое можно подавать без ограничений</a>.</p>

<h2>Где его производят сегодня</h2>
<p>Сегодня качественное кошерное вино есть почти во всех винодельческих регионах мира. Мендоса — важный центр в Аргентине, а кошерное вино также производится в Чили, Франции, Испании, Италии и, конечно, в Израиле, сертифицированное ведущими раввинскими агентствами. Качество этих вин значительно улучшилось за последние десятилетия: раньше кошерное вино имело репутацию сладкого и ограниченного качества, но сегодня оно на равных конкурирует с обычными винами в слепых дегустациях.</p>

<h2>Часто задаваемые вопросы</h2>
<p><strong>Почему у вина такие непохожие на твёрдую пищу правила?</strong><br>
Это связано с историческим происхождением ограничения: вино специально использовалось в идолопоклоннических церемониях в древности, чего не происходило таким же образом с другими продуктами, и это специфическое опасение создало собственное, более строгое правило.</p>
<p><strong>Есть ли у виноградного сока те же ограничения, что и у вина?</strong><br>
Да, неферментированный виноградный сок следует тому же критерию обращения, что и вино, именно потому, что он может ферментироваться и превратиться в вино.</p>
<p><strong>Как узнать, есть ли у бутылки вина правильный надзор?</strong><br>
Ища на этикетке печать признанного сертификатора; без этой печати нет способа подтвердить, что вся цепочка еврейского обращения была соблюдена.</p>

<h2>Читать далее</h2>
<p>Об исключении, позволяющем подавать вино без ограничений на то, кто его трогает, см. <a href="/articulos/vino-mevushal">вино мевушаль</a>. А о других напитках, где происхождение вина также играет роль, см. <a href="/articulos/alcohol-bebidas-espirituosas">алкоголь и крепкие напитки</a>.</p>',
            ],
            'gelatina-kosher' => [
                ...
                'content' => '<p>Традиционный желатин получают, вываривая кости, кожу и соединительную ткань животных — обычно коров или свиней — до извлечения коллагена. Это создаёт две проблемы с точки зрения кашрута: происхождение животного (кошерный ли это вид?) и метод обработки (была ли животное забито по <a href="/articulos/shejita-sacrificio-kosher">шхите</a>?).</p>
...
<h2>Суть спора: меняет ли трансформация статус?</h2>
<p>Десятилетиями различные раввинские авторитеты спорили о том, меняет ли желатин, проходя через столь радикальный химический процесс, свой галахический статус — концепция, называемая <em>паним хадашот</em> (буквально "новое лицо", полная трансформация). Некоторые более снисходительные мнения утверждали, что процесс настолько радикален — от кости и кожи до кристаллического порошка без вкуса, цвета и текстуры, узнаваемых от исходного животного, — что конечный продукт уже не считается мясом в галахическом смысле. Однако большинство основных кошерных сертификаторов не принимают эту позицию в отношении желатина некошерного происхождения и требуют, чтобы источник коллагена был разрешён изначально.</p>

<h2>Альтернативы, устраняющие проблему в корне</h2>
<p>Поэтому сегодня подавляющее большинство продуктов с кошерной сертификацией, требующих желатин (конфеты, десерты, капсулы лекарств, маршмеллоу), используют одну из следующих альтернатив:</p>
<ul>
<li><strong>Кошерный рыбный желатин:</strong> извлекается из видов с плавниками и чешуёй, избегая проблемы происхождения, которая есть у желатина млекопитающих.</li>
<li><strong>Говяжий желатин от животных, забитых по шхите:</strong> решает проблему у источника, хотя обычно дороже обычной альтернативы.</li>
<li><strong>Растительные заменители</strong>, такие как агар-агар (извлекаемый из водорослей) или пектин (из фруктов), полностью избегающие этого спора, поскольку не имеют животного происхождения.</li>
</ul>
<p>Когда продукт имеет печать признанного сертификатора, больше нет необходимости исследовать происхождение желатина: сертификация гарантирует, что этот момент уже проверен в рамках процесса сертификации.</p>

<h2>Где желатин появляется незаметно</h2>
<p>Помимо очевидных сладостей и десертов, желатин появляется в менее очевидных местах: капсулах лекарств и добавок, некоторых йогуртах и молочных десертах (для текстуры), винах и пивах (используется как осветляющий агент при фильтрации) и некоторых промышленных хлебобулочных изделиях. Всегда стоит проверять этикетку, не предполагая, что продукт "без вкуса желатина" его не содержит.</p>

<h2>Часто задаваемые вопросы</h2>
<p><strong>Всегда ли растительный желатин (агар-агар) кошерен?</strong><br>
По происхождению (водоросли) — да, но, как и с любым продуктом, стоит проверить, что он не обрабатывался на оборудовании, общем с некошерными ингредиентами.</p>
<p><strong>Почему у некоторых кошерных марок конфет текстура отличается от обычных?</strong><br>
Потому что многие используют рыбный желатин или растительные заменители вместо стандартного говяжьего или свиного желатина, что может слегка изменить конечную текстуру.</p>
<p><strong>Может ли продукт, помеченный просто "желатин", без дополнительных деталей, считаться некошерным?</strong><br>
Без видимой сертификации нет надёжного способа узнать; самое безопасное — искать печать признанного сертификатора.</p>

<h2>Читать далее</h2>
<p>Чтобы понять метод забоя, определяющий пригодность мяса или коллагена животного происхождения, см. <a href="/articulos/shejita-sacrificio-kosher">шхита: метод кошерного забоя</a>. А о другом столь же спорном ингредиенте см. <a href="/articulos/queso-kosher-cuajo">кошерный сыр и сычужный фермент</a>.</p>',
            ],
            'alcohol-bebidas-espirituosas' => [
...
<h2>Моменты, заслуживающие внимания</h2>
<ul>
<li><strong>Выдержка в винных или хересных бочках:</strong> некоторые виски и ромы выдерживаются в бочках, ранее содержавших некошерное вино, и этот контакт может повлиять на их статус, подобно тому как <a href="/articulos/vino-kosher">кошерные винные бочки</a> можно использовать повторно лишь ограниченное число раз.</li>
<li><strong>Ароматизаторы и добавки:</strong> ликёры со вкусом крема, шоколада или фруктов часто включают ингредиенты (красители, эссенции, стабилизаторы), требующие проверки в каждом отдельном случае.</li>
<li><strong>Напитки на винной основе</strong> (например, вермут или некоторые ликёры): наследуют все ограничения кошерного вина, включая необходимость раввинского надзора на протяжении всего производства.</li>
<li><strong>Пиво:</strong> обычно кошерно благодаря своим базовым ингредиентам (вода, ячмень, хмель, дрожжи), за исключением вариантов со специальными ароматизаторами или процессов фильтрации с осветляющими агентами животного происхождения.</li>
<li><strong>Сливочные ликёры:</strong> поскольку содержат молочные продукты, помимо анализа ингредиентов нужно учитывать и правила смешивания с мясными блюдами.</li>
</ul>

<h2>Почему водка и джин обычно проще</h2>
<p>Нейтральные крепкие напитки, такие как водка или базовый джин, обычно вызывают меньше вопросов, чем виски или ром, поскольку они, как правило, не проходят выдержку в дереве, а их ингредиенты более прямые: вода, злак или картофель, ферментированные и многократно перегнанные. Джин — промежуточный случай, поскольку во время перегонки к нему добавляют ботанические компоненты (можжевельник, цитрусовые, специи), и именно здесь стоит проверить, что эти добавки не включают проблемных ингредиентов.</p>

<h2>Песах: исключение, меняющее всё</h2>
<p>Во время Песаха, кроме того, нужно проявлять особое внимание, поскольку многие крепкие напитки изготавливаются из злаков, составляющих <a href="/articulos/jametz-pesaj">хамец</a>, поэтому в это время года требуется специальная сертификация "кошерно для Песаха". Это особенно касается виски (сделанного из ячменя) и некоторых зерновых водок, тогда как крепкие напитки на основе картофеля или сахарного тростника обычно имеют меньше дополнительных ограничений для праздника, хотя стоит подтвердить конкретную сертификацию перед покупкой.</p>

<h2>Часто задаваемые вопросы</h2>
<p><strong>Любой виски без видимой кошерной сертификации автоматически непригоден?</strong><br>
Не обязательно, но без проверки нет способа подтвердить, выдерживался ли он в некошерных винных бочках или содержит ли проблемные добавки. В случае сомнений ищите марку с признанной сертификацией.</p>
<p><strong>Может ли сам алкоголь (этанол) быть некошерным?</strong><br>
У этанола как молекулы нет проблемы кашрута; вопрос всегда касается происхождения ферментированного сырья и добавок, введённых после перегонки.</p>
<p><strong>Могут ли коктейли, приготовленные в обычном баре, считаться кошерными, если все ингредиенты кошерны?</strong><br>
Это зависит от критериев каждого человека: помимо ингредиентов, важно, использует ли бар то же оборудование для приготовлений с некошерными ингредиентами — вопрос, похожий на тот, что поднимается в <a href="/articulos/comer-kosher-restaurante">как питаться кошерно в несертифицированном ресторане</a>.</p>

<h2>Читать далее</h2>
<p>Чтобы понять, почему вино требует такого строгого надзора, что также влияет на ликёры на винной основе, см. <a href="/articulos/vino-kosher">кошерное вино</a>. А об исключении, позволяющем подавать вино без ограничений, см. <a href="/articulos/vino-mevushal">вино мевушаль</a>.</p>',
            ],
            'comer-kosher-restaurante' => [
                ...
                'content' => '<p>Сертифицированный кошерный ресторан не всегда доступен, особенно при путешествиях или проживании в городах со слабой общинной инфраструктурой. Тем не менее существуют стратегии оставаться в рамках кашрута в обычных ресторанах, и не все они означают остаться голодным.</p>
...
<h2>Самые безопасные варианты, от строгого к более гибкому</h2>
<ul>
<li><strong>Бутилированные и запечатанные напитки:</strong> вода, газировка и соки в оригинальной упаковке обычно не вызывают вообще никаких проблем, независимо от места покупки.</li>
<li><strong>Сырые фрукты и овощи:</strong> без приготовления и сложной обработки они обычно являются самым безопасным вариантом практически везде в мире.</li>
<li><strong>Вегетарианские или веганские варианты:</strong> убирая мясо и молочные продукты из блюда, риск значительно снижается, хотя всё равно нужно спрашивать про скрытые ингредиенты (мясной бульон в жарком из овощей, сливочное масло в пюре, соусы на животной основе).</li>
<li><strong>Рыба с плавниками и чешуёй:</strong> в ресторанах простой кухни рыба на гриле без соусов может быть разумной альтернативой для тех, кто придерживается более гибкого подхода, при условии, что она не готовится вместе с морепродуктами или некошерным мясом на том же оборудовании — это уже зависит от критериев каждого человека и общины.</li>
</ul>
<p>Чего почти никакое мнение не допускает — это мясо или птицу из несертифицированного ресторана, независимо от того, как выглядит блюдо: здесь важны и происхождение животного, и метод забоя (<a href="/articulos/shejita-sacrificio-kosher">шхита</a>), которые невозможно проверить на глаз.</p>

<h2>Реальный пример того, как это решается на практике</h2>
<p>Однажды мы поехали в отпуск в Мар-дель-Плату с ещё маленькими детьми, и, подъезжая по проспекту Конститусьон, жена вспомнила, что забыла печенье. Зимой в тех краях найти кошерный хлеб или печенье практически невозможно. Что давать детям? Дома мы обычно не ели определённые упакованные снеки, но в этой крайней ситуации мы обратились к списку Ajdut Kosher — путеводителю по одобренным продуктам на полках супермаркетов, который публикует эта сертификация. Мы просмотрели разрешённые марки и нашли печенье вроде "Travitas", которое было в списке. Это нас спасло.</p>
<p>Вывод: когда путешествуешь, иметь под рукой список одобренных продуктов надёжной сертификации — это на вес золота. Огромное количество обычных супермаркетских продуктов кошерны, даже если на упаковке не напечатана большая печать, и знание этого списка открывает варианты там, где, казалось, их совсем нет. Сегодня большинство сертификаторов публикуют такие списки онлайн или в приложении, поэтому стоит сохранить один на телефоне перед поездкой, а не искать его только в момент нужды.</p>

<h2>Что спрашивать на кухне: что действительно помогает</h2>
<p>Если собираетесь есть что-то, приготовленное на месте, некоторые вопросы помогают больше других. Спрашивать официанта "это кошерно?" редко срабатывает, если он не знает, что означает это слово. Полезнее спросить что-то конкретное: на этом масле раньше жарили что-то ещё?, эта же сковорода используется для мяса?, есть ли сливочное масло или сливки в приготовлении? Чем конкретнее вопрос, тем надёжнее ответ.</p>

<h2>Разные уровни строгости и почему они так различаются</h2>
<p>У каждого человека и каждой общины свой порог того, что считается приемлемым вне сертифицированного ресторана. Некоторые семьи едят только фабрично упакованные и запечатанные продукты, без исключений. Другие принимают определённые простые блюда (салат, чай) в обычных ресторанах, но не сложные блюда. Единого правильного ответа нет: это зависит от семейного обычая и от того, за каким раввином кто следует. При сомнении в конкретном случае лучше спросить заранее, перед поездкой, а не импровизировать на месте.</p>

<h2>Часто задаваемые вопросы</h2>
<p><strong>Веганский ресторан автоматически приемлем?</strong><br>
Не обязательно. Отсутствие ингредиентов животного происхождения не решает всё: общее оборудование и вопрос бишуль акум (пища, полностью приготовленная неевреем) остаются актуальными в зависимости от того, какого мнения придерживаются. Мы подробнее рассматриваем это в <a href="/articulos/kashrut-y-veganismo">кашрут и веганство</a>.</p>
<p><strong>Что делать, если еду в город вообще без еврейской общины?</strong><br>
Отдавать предпочтение упакованному и запечатанному (с видимой сертификацией), что привезли с собой или нашли в супермаркете, плюс сырым фруктам и овощам. Многие путешественники держат запас сертифицированных непортящихся продуктов на такие случаи.</p>
<p><strong>Показывают ли приложения доставки, кошерное ли место?</strong><br>
У некоторых сертификаторов есть собственные приложения или онлайн-списки сертифицированных ресторанов в регионе, которые обычно надёжнее, чем полагаться на описание места в обычном приложении доставки.</p>

<h2>Читать далее</h2>
<p>Чтобы понять, что делает место действительно сертифицированным, см. <a href="/articulos/simbolos-certificacion-kosher">символы кошерной сертификации</a>. А если цель — создать собственную кухню, чтобы меньше зависеть от еды вне дома, см. <a href="/articulos/armar-cocina-kosher">как создать кошерную кухню с нуля</a>.</p>',
            ],
            'simbolos-certificacion-kosher' => [
                ...
                'content' => '<p>Когда продукт проходит процесс кошерной сертификации, сертифицирующее агентство разрешает использовать символ (hechsher) на упаковке, позволяющий идентифицировать его с первого взгляда. В мире существуют сотни сертификаторов, но некоторые особенно известны своим глобальным охватом, и умение их распознавать сильно экономит время при покупках.</p>
...
<h2>Самые узнаваемые символы в мире</h2>
<ul>
<li><strong>OU (Orthodox Union):</strong> буква "U" в круге. Вероятно, самый узнаваемый кошерный символ в мире, базирующийся в США и присутствующий на десятках тысяч продуктов.</li>
<li><strong>OK Kosher Certification:</strong> буква "K" в круге, ещё одно крупное американское агентство, очень сильное в промышленных продуктах и добавках.</li>
<li><strong>Star-K:</strong> звезда с буквой "K" в центре, базирующаяся в Балтиморе.</li>
<li><strong>KSA (Kosher Supervision of America):</strong> сертификатор с сильным присутствием в промышленных продуктах и ароматизаторах.</li>
<li><strong>Бадац:</strong> печать, используемая несколькими раввинскими судами в Израиле, ассоциируемая с очень высокими стандартами строгости (существует несколько разных Бадацев, а не единая организация).</li>
<li><strong>Местные сертификаторы:</strong> в таких странах, как Аргентина, Бразилия или Мексика, существуют местные общинные сертификаторы (например, Ваад ха-Кашрут каждой общины) со своими печатями, обычно признаваемыми только внутри этой общины или страны.</li>
</ul>

<h2>Буквы, сопровождающие символ</h2>
<p>Помимо символа, многие этикетки включают дополнительную букву: "D" (молочный), "M" (мясной), "Pareve" (парве) или "DE" (изготовлено на молочном оборудовании, но без прямых молочных ингредиентов). Это последнее различие важно: продукт "DE" не подходит для употребления сразу после мяса, даже если не содержит молочных ингредиентов. Знание этих символов значительно ускоряет покупки, особенно при путешествиях в страны, язык которых не знаком.</p>

<h2>Хехшер — это не разовая формальность: это постоянный надзор</h2>
...
<h2>Почему некоторые общины принимают только определённые печати</h2>
<p>Не каждый раввин или община принимает одни и те же хехшерим. Некоторые критерии более гибкие и доверяют широкому кругу признанных сертификаторов; другие, особенно более строгие общины, доверяют лишь горстке печатей, стандарты которых они хорошо знают. Нередко можно увидеть "списки надёжных хехшерим", которые каждая община публикует для своих членов. При сомнении, принимается ли конкретная печать, проще всего спросить непосредственно раввина общины.</p>

<h2>Часто задаваемые вопросы</h2>
<p><strong>Может ли продукт без какого-либо символа всё же быть кошерным?</strong><br>
Технически да, если все его ингредиенты кошерны и не было контакта с некошерным оборудованием, но без сертификации нет способа подтвердить это извне. Именно для этого и существует хехшер.</p>
<p><strong>Все ли символы с буквой "K" надёжны?</strong><br>
Нет. В отличие от "OU" или "OK", отдельная буква "K" не зарегистрирована как товарный знак каким-либо конкретным агентством, поэтому любой производитель может напечатать её, не подразумевая реального надзора. Стоит с осторожностью относиться к отдельной "K" без опознаваемого агентства за ней.</p>
<p><strong>Означают ли символы одно и то же во всех странах?</strong><br>
Дизайн символа обычно постоянен, так как он зарегистрирован сертификатором, но уровень доверия, который каждая община ему оказывает, варьируется в зависимости от страны и религиозного течения.</p>

<h2>Читать далее</h2>
<p>Чтобы подробно понять разницу между "D", "M" и "Pareve", см. <a href="/articulos/que-significa-pareve">что значит парве</a>. А если хотите прочитать полную этикетку помимо символа, см. <a href="/articulos/como-leer-etiqueta-kosher">как читать этикетку кошерного продукта</a>.</p>',
            ],
            'que-significa-pareve' => [
...
<p>Кроме того, мясо должно пройти процесс засолки (кашерование) для удаления крови, поскольку Тора запрещает употребление крови. Это делается путём замачивания мяса в воде, посолки и выдержки перед повторным ополаскиванием — процесс, который сегодня обычно выполняет сама сертифицированная мясная лавка или бойня до того, как продукт попадёт к потребителю.</p>',
            ...
            'glatt-kosher' => [
                ...
                'content' => '<p>"Глатт" означает "гладкий" на идише и изначально относился конкретно к состоянию лёгких животного после <a href="/articulos/shejita-sacrificio-kosher">шхиты</a>: если лёгкие не имели спаек (сирха), животное считалось "глатт" — высшим уровнем уверенности в том, что мясо бесспорно кошерно.</p>
...
<h2>Техническое происхождение: лёгкие животного</h2>
<p>Во время осмотра после шхиты один из ключевых этапов — проверка лёгких животного на наличие спаек (сирхот), которые могут указывать на болезнь или перфорацию, делающую животное некошерным. Когда лёгкое выглядит полностью гладким, без единой спайки, животное классифицируется как "глатт". Если есть незначительные спайки, которые опытный проверяющий (бодек) считает возможным удалить без перфорации, животное всё равно может считаться кошерным по стандартному критерию, но не как "глатт".</p>

<h2>Как это стало из технического термина общим знаком строгости</h2>
<p>Со временем, особенно в ашкеназских общинах США, термин "глатт кошер" разговорно расширился, чтобы описывать общий стандарт большей строгости на протяжении всей производственной цепочки продукта, а не только при осмотре лёгких. Сегодня обычно можно увидеть "глатт кошер" на этикетках ресторанов и продуктов, чтобы указать, что они соответствуют самым строгим возможным критериям, даже в контекстах, где исходный технический термин (лёгкие животного) вообще не применим.</p>

<h2>Является ли обычный кошер "менее действительным"?</h2>
<p>Важно подчеркнуть, что "кошерный" продукт без маркировки "глатт" не менее действителен с галахической точки зрения: он просто следует другому стандарту сертификации, как правило, принятому подавляющим большинством общин и раввинских авторитетов. Выбор между стандартным кошер и глатт кошер обычно зависит от семейного или общинного обычая, а не от объективного различия в действительности. Многие семьи, не соблюдающие глатт ежедневно, всё же выбирают его для особых случаев, таких как свадьба или важный праздник.</p>
<p>В случае птицы и рыбы понятие "глатт" технически не применяется так же, поскольку птица не проходит такой же тип проверки лёгких, хотя в разговорной речи иногда используется для обозначения в целом более строгого уровня надзора.</p>

<h2>Часто задаваемые вопросы</h2>
<p><strong>Всё ли мясо глатт кошер дороже?</strong><br>
Как правило, да, поскольку процесс отбора строже и отбраковывается больший процент животных, что сокращает доступное предложение по отношению к спросу.</p>
<p><strong>Нечестен ли ресторан, который говорит "кошер" без указания "глатт"?</strong><br>
Нет, он просто точен: он следует стандартному кошерному критерию, полностью действительному для подавляющего большинства общин.</p>
<p><strong>Гарантирует ли "глатт", что соблюдались и другие правила, например бишуль акум?</strong><br>
Не автоматически. "Глатт" относится конкретно к уровню проверки мяса; другие правила, такие как <a href="/articulos/bishul-akum">бишуль акум</a>, проверяются отдельно в рамках общего процесса сертификации.</p>

<h2>Читать далее</h2>
<p>Чтобы понять полный процесс кошерного мяса, от забоя до проверки, см. <a href="/articulos/shejita-sacrificio-kosher">шхита: метод кошерного забоя</a>. А чтобы распознавать печати, подтверждающие всё это на этикетке, см. <a href="/articulos/simbolos-certificacion-kosher">символы кошерной сертификации</a>.</p>',
            ],
            'como-leer-etiqueta-kosher' => [
                ...
                'content' => '<p>Правильное чтение кошерной этикетки выходит за рамки поиска символа сертификации. Есть несколько элементов, которые всегда стоит проверять, и умение читать их полностью избавляет от сюрпризов за столом.</p>
...
<h2>Четыре вещи, которые стоит искать по порядку</h2>
<ul>
<li><strong>Символ сертификатора:</strong> определяет, какое агентство контролировало продукт. Важно распознавать надёжных сертификаторов (подробно рассмотрены в <a href="/articulos/simbolos-certificacion-kosher">символах кошерной сертификации</a>), поскольку не все символы в мире имеют одинаковый уровень строгости.</li>
<li><strong>Категория:</strong> "Dairy" или "D" (молочный), "Meat" или "M" (мясной), "Pareve" (парве) или "Fish" (рыба, которая во многих традициях рассматривается как отдельная от мяса категория). Эта буква определяет, с какими другими продуктами можно сочетать данный продукт.</li>
<li><strong>"Кошерно для Песаха":</strong> дополнительное обозначение, необходимое во время праздника, отличное от обычной кошерной сертификации в остальное время года. Продукт может быть кошерным весь год, но непригодным для Песаха, если содержит какой-либо производный из пяти видов злаков.</li>
<li><strong>Дата или код сертификации:</strong> некоторые сертификаторы включают код или дату, чтобы подтвердить, что печать всё ещё действительна, поскольку рецепты и заводские процессы могут меняться, и сертификация может быть утрачена без изменения дизайна упаковки.</li>
</ul>

<h2>Категория "DE": деталь, которую чаще всего упускают</h2>
<p>Помимо "D", "M" и "Pareve", некоторые этикетки включают "DE" (dairy equipment): это значит, что продукт не содержит молочных ингредиентов, но был изготовлен на том же оборудовании, что и молочные продукты. На практике многие мнения относятся к продукту "DE" более гибко, чем к настоящему "D", но не как к чистому парве. Стоит подробно разобраться в этой разнице в <a href="/articulos/que-significa-pareve">что значит парве</a>.</p>

<h2>Почему не стоит предполагать по умолчанию</h2>
<p>Когда у продукта нет видимой сертификации, но список ингредиентов выглядит простым (например, только вода, соль и овощ), возникает соблазн предположить, что он кошерен по умолчанию. Общая рекомендация авторитетов кашрута — не делать этого: многие добавки и промышленные процессы не очевидны на первый взгляд, от ферментов, используемых при обработке, до оборудования, общего с другими продуктами на той же производственной линии.</p>

<h2>Часто задаваемые вопросы</h2>
<p><strong>Продукт без напечатанной категории (D/M/Pareve) всегда парве?</strong><br>
Не предполагайте этого. Отсутствие буквы само по себе ничего не подтверждает; если этикетка не уточняет категорию, стоит поискать продукт напрямую в базе данных сертификатора.</p>
<p><strong>Заменяют ли приложения для сканирования штрих-кодов необходимость проверки физической этикетки?</strong><br>
Они очень помогают, но лучше использовать их как дополнение, а не полную замену, особенно с импортными или недавно произведёнными продуктами, которые база данных ещё не обновила.</p>
<p><strong>Во всех ли странах кошерная этикетка должна быть на местном языке?</strong><br>
Нет, часто встречаются импортные продукты с кошерной информацией только на языке происхождения (иврит, английский), что делает более ценным умение визуально распознавать символы, а не полагаться на текст.</p>

<h2>Читать далее</h2>
<p>Чтобы распознавать самые распространённые печати с первого взгляда, см. <a href="/articulos/simbolos-certificacion-kosher">символы кошерной сертификации</a>. На KosherMap вы также можете искать продукты по названию или штрих-коду и фильтровать напрямую по сертификатору, категории и типу, чтобы не зависеть только от физической этикетки.</p>',
            ],
            'bishul-akum' => [
...
<h2>Какие продукты попадают в эту категорию (а какие нет)</h2>
<p>Этот закон применяется не ко всем продуктам: обычно он ограничивается продуктами, считающимися "достойными подачи на царском столе" (хашивут) и не употребляемыми сырыми. Поэтому фрукты, сырые овощи и большинство промышленных закусок не подпадают под эту категорию. Критерий "хашивут" частично субъективен и варьируется в зависимости от общины: сложное рагу явно подпадает, тогда как просто отваренный овощ вызывает больше споров среди разных мнений.</p>

<h2>Как это решается на фабрике или в сертифицированном ресторане</h2>
...
<ul>
<li><strong>Соблюдающий еврей активно участвует в процессе приготовления</strong>, например, зажигая огонь или оборудование перед началом производственного процесса.</li>
<li><strong>Раввинский надзор подтверждает</strong>, что еврейский представитель присутствовал при включении кулинарного оборудования в каждую производственную смену, даже если остальной процесс затем ведёт нееврейский персонал.</li>
</ul>
...
<h2>Почему это влияет на некошерные рестораны</h2>
<p>Это одна из основных причин, по которой блюдо, приготовленное в несертифицированном ресторане, вызывает сомнения, даже если все ингредиенты кажутся пригодными: помимо происхождения мяса или общего оборудования, важно также, кто фактически зажёг огонь и вёл приготовление. Тема раскрывается на конкретных примерах в <a href="/articulos/comer-kosher-restaurante">как питаться кошерно в несертифицированном ресторане</a>.</p>

<h2>Часто задаваемые вопросы</h2>
<p><strong>Применяется ли бишуль акум также дома, с нееврейской домашней прислугой?</strong><br>
Да, принцип тот же независимо от места приготовления; меняется практическое решение — обычно участие члена семьи-еврея в зажигании.</p>
<p><strong>Решает ли электрическая духовка с таймером проблему зажигания?</strong><br>
Это зависит от галахического мнения, которого придерживаются; некоторые принимают это как форму "участия" еврейского владельца, другие требуют более прямого действия. В случае сомнений консультируйтесь с раввином общины.</p>
<p><strong>Связан ли бишуль акум с откошерованием посуды?</strong><br>
Это разные категории: бишуль акум касается того, кто готовит, тогда как откошерование (например, <a href="/articulos/hagala-utensilios-metal">агала</a>) касается того, что посуда впитала ранее.</p>

<h2>Читать далее</h2>
<p>Чтобы увидеть, как этот принцип применяется на практике при еде вне дома, см. <a href="/articulos/comer-kosher-restaurante">как питаться кошерно в несертифицированном ресторане</a>. А о другой категории, где очень важно, кто обращается с продуктом, см. <a href="/articulos/vino-kosher">кошерное вино</a>.</p>',
            ],
            'vino-mevushal' => [
                ...
                'content' => '<p>Как мы видели, говоря о <a href="/articulos/vino-kosher">кошерном вине</a>, общее правило требует, чтобы только соблюдающие евреи трогали вино от производства до подачи. Вино мевушаль ("варёное" или пастеризованное) — практическое исключение из этого правила: после того как вино проходит процесс нагрева при определённой минимальной температуре, оно сохраняет свой кошерный статус независимо от того, кто его подаёт впоследствии.</p>
...
<h2>Почему тепло меняет всё</h2>
<p>Эта категория существует благодаря галахическому принципу, согласно которому вино, изменённое теплом, теряет ритуальное "достоинство", изначально мотивировавшее ограничение, поскольку исторически это опасение было направлено на использование вина в идолопоклоннических церемониях — то, для чего варёное вино не годилось в этом контексте. Потеряв этот статус, уже не важно, кто его трогает или подаёт впоследствии: оно может пройти через нееврейские руки, не теряя кошерного статуса.</p>

<h2>Где оно используется чаще всего</h2>
<p>Вино мевушаль очень популярно для:</p>
<ul>
<li><strong>Кейтеринга и мероприятий:</strong> свадеб, бар/бат-мицв и приёмов, где обслуживающий персонал не обязательно еврейский.</li>
<li><strong>Кошерных ресторанов, открытых для широкой публики:</strong> позволяет любому официанту подавать вино без специального надзора за каждым столом.</li>
<li><strong>Авиакомпаний и отелей</strong>, предлагающих кошерные варианты, где было бы невозможно гарантировать, что только еврейский персонал трогает каждую бутылку.</li>
<li><strong>Синагог и крупных общинных мероприятий</strong>, где вино проходит через множество рук во время кидуша.</li>
</ul>

<h2>Как его пастеризуют, не жертвуя вкусом</h2>
<p>Долгое время кипячение вина традиционным способом значительно ухудшало вкус, и мевушаль имело репутацию вина низкого качества. Сегодня существуют современные методы быстрой пастеризации, при которых вино нагревают до нужной минимальной температуры всего на несколько секунд и сразу же охлаждают, что раньше было гораздо труднее достичь без ущерба для вкуса. Это значительно расширило ассортимент премиальных вин мевушаль на рынке, включая марки известных виноделен, которые раньше производили только вино не мевушаль.</p>

<h2>Часто задаваемые вопросы</h2>
<p><strong>Всё ли кошерное вино, продаваемое в супермаркетах, — мевушаль?</strong><br>
Нет, на общем рынке также существуют кошерные вина не мевушаль. Стоит проверить этикетку или сайт сертификатора, если это важно для вашего использования (например, если вы подаёте его на мероприятии с нееврейским персоналом).</p>
<p><strong>Мевушаль ниже качеством, чем обычное кошерное вино?</strong><br>
Уже не обязательно. С современными методами быстрой пастеризации многие виноделы производят мевушаль премиум-класса, неотличимое в слепой дегустации от непастеризованной версии.</p>
<p><strong>Может ли вино стать мевушаль после розлива в бутылки?</strong><br>
Нет, процесс нагрева должен происходить до или во время производства, под надзором, и это указывается на этикетке или в карточке продукта у сертификатора.</p>

<h2>Читать далее</h2>
<p>Чтобы понять, почему обычное вино требует такого строгого надзора изначально, см. <a href="/articulos/vino-kosher">кошерное вино: почему оно требует особого надзора</a>. Тема также связана с <a href="/articulos/bishul-akum">бишуль акум</a> — ещё одной категорией, где важно, кто обращается с едой.</p>',
            ],
            'tevilat-kelim' => [
...
<h2>Какая посуда нуждается в твиле, а какая нет</h2>
<p>Этот обычай в основном применяется к посуде, находящейся в прямом контакте с пищей: кастрюлям, сковородам, столовым приборам, стеклянным тарелкам и стаканам. Обычно он не применяется к электроприборам (например, тостеру или блендеру) или к пластиковой или деревянной посуде, хотя мнения варьируются в зависимости от традиции каждой общины, поэтому рекомендуется консультироваться с раввином по конкретным случаям. Общий критерий, используемый для этого различия, похож на тот, что определяет необходимость <a href="/articulos/hagala-utensilios-metal">агалы</a>: чем прямее контакт с пищей и долговечнее материал, тем вероятнее необходимость погружения.</p>

<h2>Процесс шаг за шагом</h2>
<ol>
<li>Хорошо очистить посуду, без остатков этикеток, пломб или клея, которые могут встать между водой и поверхностью.</li>
<li>Проверить отсутствие какого-либо вещества (жир, ржавчина, остатки упаковки), действующего как барьер.</li>
<li>Полностью погрузить в воду миквы или в подходящий природный источник воды во время произнесения благословения (для посуды, требующей этого согласно традиции).</li>
<li>После правильного погружения посуда готова к обычному использованию, без дополнительных шагов.</li>
</ol>

<h2>Где это делать на практике</h2>
<p>Во многих общинных миквах есть конкретное время, выделенное для твилат келим, отдельно от личного ритуального использования, а также подробные инструкции о том, какие материалы требуют погружения, а какие нет. В некоторых более крупных общинах даже есть отдельный бассейн, посвящённый исключительно этому использованию, чтобы не смешивать расписание с миквой для личного ритуального использования.</p>

<h2>Часто задаваемые вопросы</h2>
<p><strong>Нуждается ли посуда б/у в твиле так же, как новая?</strong><br>
Да, если она изначально была изготовлена или продана нееврейской стороной, обычай применяется независимо от того, новая посуда или бывшая в употреблении.</p>
<p><strong>Что делать, если купил посуду, а рядом нет миквы?</strong><br>
Можно использовать любой природный источник воды, отвечающий галахическим требованиям (реку, море), хотя на практике большинство людей обращается к ближайшей общинной микве с подходящим расписанием.</p>
<p><strong>Нуждается ли посуда, купленная у еврейского производителя, тоже в твиле?</strong><br>
Как правило, нет; обычай специально сосредоточен на посуде нееврейского происхождения.</p>

<h2>Читать далее</h2>
<p>О других практических шагах при оснащении кухни с нуля, включая этот обычай, см. <a href="/articulos/armar-cocina-kosher">как организовать кошерную кухню с нуля</a>. А о методе, используемом для очищения посуды, впитавшей некошерный вкус, см. <a href="/articulos/hagala-utensilios-metal">агала: как откошеровать металлическую посуду</a>.</p>',
            ],
            'armar-cocina-kosher' => [
...
<h2>Наиболее распространённые шаги</h2>
<ul>
...
<li><strong>Разделить рабочие поверхности:</strong> разделочные доски, кухонные полотенца и губки также должны быть разделены по категориям, желательно храниться в разных местах кухни, чтобы избежать случайного смешивания.</li>
...
<li><strong>Покупать сертифицированные продукты:</strong> проверять символ сертификации при каждой покупке, пока это не станет автоматической привычкой, не требующей размышлений.</li>
<li><strong>Координировать с раввином:</strong> особенно для откошерования предметов, которые уже были на кухне до начала этого процесса, и для решения точечных вопросов о конкретных материалах или предметах.</li>
<li><strong>Добавить твилат келим:</strong> новая металлическая или стеклянная посуда, купленная у нееврейского производителя, нуждается в ритуальном погружении перед первым использованием.</li>
</ul>

<h2>Идти постепенно: порядок, который больше всего облегчает переход</h2>
<p>Стратегия, часто используемая начинающими, — постепенно внедрять разделение: сначала предметы повседневного использования (кастрюли, сковороды, столовые приборы), затем столовую посуду, и, наконец, бытовую технику, которая обычно самая дорогая и сложная в решении. Не обязательно заменять всю кухню сразу, и многим семьям требуются месяцы для завершения перехода, и это само по себе не является галахической проблемой: важно намерение продолжать двигаться вперёд, а не скорость.</p>

<h2>Бюджет: как распределить инвестиции</h2>
<p>Организация целой кухни с нуля может показаться дорогой, если рассматривать это как единовременный расход. На практике большинство семей распределяют это на небольшие, разнесённые во времени покупки: набор кастрюль в этом месяце, столовые приборы в следующем и так далее. Общинные магазины и базары часто предлагают комплекты, специально разработанные для этого, по более доступным ценам, чем покупка всего по отдельности.</p>

<h2>Часто задаваемые вопросы</h2>
<p><strong>Нужно ли выбрасывать всё, что уже было на кухне, прежде чем начинать?</strong><br>
Не обязательно. Многие предметы можно откошеровать в зависимости от материала (см. <a href="/articulos/hagala-utensilios-metal">агала</a>); только то, что нельзя откошеровать, например большинство керамики, нужно заменить.</p>
<p><strong>Нужны ли микроволновке два отдельных устройства — для мяса и для молока?</strong><br>
Это не обязательно: многие семьи используют одну микроволновку, закреплённую "только для парве", или откошеровывают её между использованиями, как описано в <a href="/articulos/kasherizar-horno">как откошеровать духовку</a> (принцип похож).</p>
<p><strong>Сколько времени в среднем занимает переход?</strong><br>
Это сильно варьируется в зависимости от бюджета и темпа каждой семьи, но нередко это занимает от нескольких месяцев до года, чтобы спокойно завершить все шаги.</p>

<h2>Читать далее</h2>
<p>Подробнее о ритуальном погружении новой посуды см. <a href="/articulos/tevilat-kelim">твилат келим</a>. А чтобы понять метод, используемый для откошерования того, что уже было дома, см. <a href="/articulos/hagala-utensilios-metal">агала: как откошеровать металлическую посуду</a>.</p>',
            ],
            'certificaciones-kosher-mundo' => [
                ...
                'content' => '<p>Хотя фундаментальные принципы кашрута универсальны, в мире существуют сотни сертифицирующих агентств, и у каждого могут быть несколько разные критерии по конкретным темам — например, какой уровень надзора требуется для <a href="/articulos/bishul-akum">бишуль акум</a>, или как они подходят к определённым химическим добавкам, происхождение которых трудно отследить.</p>
...
<h2>Как сертификация различается по регионам</h2>
<ul>
<li><strong>США:</strong> здесь находятся крупнейшие промышленные сертификаторы (OU, OK, Star-K, Kof-K), с очень стандартизированными процессами для массового экспорта. Продукт, сертифицированный там, обычно достигает десятков стран практически в неизменном виде.</li>
<li><strong>Израиль:</strong> Раввинат предлагает официальную государственную сертификацию, в то время как такие организации, как Бадац, поддерживают дополнительные стандарты, считающиеся более строгими определёнными общинами, иногда создавая два уровня сертификации на одном продукте.</li>
<li><strong>Европа:</strong> такие сертификаторы, как Бейт-дин различных городов (Лондон, Париж, Цюрих), контролируют как местное производство, так и импорт, адаптируясь к рынкам с меньшим промышленным масштабом, чем в США.</li>
<li><strong>Латинская Америка:</strong> у каждой общины обычно есть свой местный Ваад ха-Кашрут (например, в Буэнос-Айресе, Сан-Паулу или Мехико), сертифицирующий как местные продукты, так и рестораны, обычно с охватом, ограниченным своим городом или страной.</li>
</ul>

<h2>Почему не существует единого агентства</h2>
<p>В отличие от других знаков качества, не существует единого центрального органа кашрута в мировом масштабе. Каждый сертификатор отвечает перед своей цепочкой раввинов-надзирателей, и его признание строится со временем на доверии, которое другие общины и раввины ему оказывают. Поэтому сертификатор может быть очень уважаем в стране происхождения и практически неизвестен в другом месте, и это не означает, что он менее серьёзен.</p>

<h2>Что делать с незнакомой печатью</h2>
<p>Для потребителя самое важное — научиться распознавать активных сертификаторов в своём регионе (подробно рассмотрены в <a href="/articulos/simbolos-certificacion-kosher">символах кошерной сертификации</a>). И в случае сомнений относительно незнакомого символа проконсультироваться с раввином общины или изучить репутацию агентства, прежде чем доверять продукту. Большинство крупных сертификаторов публикуют на своих сайтах открытые списки сертифицированных продуктов, что особенно полезно при покупке импортных товаров.</p>

<h2>Часто задаваемые вопросы</h2>
<p><strong>Автоматически ли продукт, сертифицированный в одной стране, принимается в другой?</strong><br>
Не всегда. Это зависит от взаимного признания между сертификаторами и от критериев каждой общины; некоторые семьи доверяют лишь ограниченному списку агентств, независимо от происхождения продукта.</p>
<p><strong>Существует ли единый глобальный список надёжных сертификаторов?</strong><br>
Единого официального списка нет, но многие региональные раввинские организации публикуют собственные списки агентств, которые они признают, служащие практическим ориентиром.</p>
<p><strong>Почему у некоторых продуктов два или три разных знака?</strong><br>
Обычно это происходит, когда производитель хочет охватить рынки или общины с разными критериями доверия и добивается одобрения нескольких признанных агентств в каждом регионе.</p>

<h2>Читать далее</h2>
<p>Чтобы распознавать самые распространённые символы с первого взгляда, см. <a href="/articulos/simbolos-certificacion-kosher">наиболее распространённые символы кошерной сертификации</a>. А чтобы понять всю информацию, которую этикетка может нести помимо знака, см. <a href="/articulos/como-leer-etiqueta-kosher">как читать этикетку кошерного продукта</a>.</p>',
            ],
            'queso-kosher-cuajo' => [
                ...
                'content' => '<p>Сычуг (rennet) — это фермент, традиционно используемый для свёртывания молока и отделения сыворотки при изготовлении сыра. Проблема с точки зрения кашрута в том, что традиционный сычуг извлекается из желудка телят, и чтобы быть пригодным, это животное должно быть забито по <a href="/articulos/shejita-sacrificio-kosher">шхите</a> — то, что почти никогда не происходит в обычной сыродельной промышленности.</p>
...
<h2>Почему "обычный" сыр почти никогда не кошерен по умолчанию</h2>
<p>Поэтому практически весь "обычный" сыр на рынке, даже изготовленный только из молока и сычуга, не является кошерным без специальной сертификации, так как происхождение сычуга невозможно проверить визуально. Ни цвет, ни вкус, ни текстура сыра не меняются в зависимости от типа используемого сычуга, поэтому их невозможно различить без информации от производителя.</p>

<h2>Три альтернативы, которые используют производители</h2>
<p>Варианты, используемые производителями кошерного сыра, включают:</p>
<ul>
<li><strong>Кошерный животный сычуг:</strong> извлечённый из животных, забитых по шхите и под раввинским надзором на протяжении всей цепочки, от забоя до извлечения фермента.</li>
<li><strong>Микробный сычуг:</strong> производимый путём ферментации грибов или бактерий, без животного происхождения, всё чаще используемый как в промышленных, так и в кошерных сырах, поскольку он также решает проблему для потребителей-вегетарианцев.</li>
<li><strong>Растительный сычуг:</strong> извлечённый из определённых растений (например, чертополоха), традиционно используемый в некоторых конкретных сортах кустарных сыров, особенно на Пиренейском полуострове.</li>
</ul>

<h2>Гвинат Исраэль: критерий, выходящий за рамки сычуга</h2>
<p>Помимо сычуга, есть ещё один важный фактор: многие общины требуют, чтобы сыр изготавливался под постоянным еврейским надзором (Гвинат Исраэль), чтобы считать его полностью кошерным — дополнительный критерий помимо простого анализа ингредиентов, приближающийся к принципу, лежащему в основе <a href="/articulos/bishul-akum">бишуль акум</a>: правильных ингредиентов недостаточно, важно также, кто контролирует процесс.</p>

<h2>Часто задаваемые вопросы</h2>
<p><strong>Автоматически ли веганские или "безмолочные" сыры кошерны?</strong><br>
Не обязательно. Даже если они избегают проблемы животного сычуга, всё равно нужно проверить остальные ингредиенты и используемое оборудование, как и с любым другим промышленным продуктом.</p>
<p><strong>Несёт ли упакованный тёртый сыр тот же риск, что и целый кусок?</strong><br>
Да, и иногда даже больше: процесс натирания и упаковки может добавить другие ингредиенты (антислёживающие агенты, консерванты), также требующие проверки.</p>
<p><strong>Как узнать, использует ли сыр микробный или животный сычуг без сертификации?</strong><br>
Без видимой сертификации нет надёжного способа узнать это по этикетке; поэтому покупка сыра с признанным знаком — самый безопасный способ избежать ошибок.</p>

<h2>Читать далее</h2>
<p>Чтобы понять метод забоя, определяющий пригодность животного сычуга, см. <a href="/articulos/shejita-sacrificio-kosher">шхита: метод кошерного забоя</a>. А о другом столь же спорном ингредиенте животного происхождения см. <a href="/articulos/gelatina-kosher">кошерный желатин: галахический спор</a>.</p>',
            ],
            'huevos-kosher' => [
...
<p>Процедура проста: разбивая яйцо, желток (а иногда и белок) визуально проверяют на просвет, ища красные точки или пятна. Стоит разбивать каждое яйцо в отдельную ёмкость, прежде чем добавлять его в большую смесь, именно для того, чтобы можно было его выбросить, не испортив остальное приготовление. Если обнаружена кровь, яйцо полностью выбрасывается; если желток чист, яйцо пригодно для обычного использования.</p>

<h2>Почему это происходит в некоторых яйцах</h2>
<p>Пятно крови обычно возникает из-за разрыва кровеносного сосуда во время формирования яйца внутри курицы, и не имеет никакого отношения к тому, оплодотворено ли яйцо, или к какой-либо проблеме здоровья птицы. Это чаще встречается у яиц более старых кур, хотя может появиться в любом яйце без предсказуемой закономерности, поэтому проверка проводится всегда, а не только "когда выглядит подозрительно".</p>

<h2>Дополнительные факты о яйцах и кашруте</h2>
<ul>
<li>Скорлупа и белок обычно не представляют такого же риска, как желток, хотя обычай варьируется в зависимости от общины: некоторые проверяют обе части с одинаковой тщательностью.</li>
<li>Яйца некошерных птиц (например, страуса или некоторых хищных птиц) также непригодны, независимо от наличия крови, поскольку основная проблема — происхождение птицы, а не сама кровь.</li>
<li>Промышленные продукты с яйцом (например, паста или майонез) обычно проходят процесс контроля качества, автоматически обнаруживающий яйца с кровью с помощью просвечивания, но всё равно требуют сертификации, чтобы гарантировать, что этот контроль проводился по правильным критериям.</li>
</ul>

<h2>Часто задаваемые вопросы</h2>
<p><strong>Нужно ли проверять также перепелиные или утиные яйца?</strong><br>
Да, тот же критерий применяется к яйцам любой кошерной птицы, не только куриным.</p>
<p><strong>Можно ли спасти яйцо с очень маленьким пятном, удалив только эту часть?</strong><br>
Мнения различаются в зависимости от традиции и размера пятна; некоторые разрешают удалить только поражённую точку, другие требуют выбросить всё яйцо. В случае сомнений лучше следовать более строгому мнению или консультироваться с раввином.</p>
<p><strong>Приходят ли яйца с кошерной сертификацией уже проверенными с фабрики?</strong><br>
Это не заменяет домашнюю проверку: сертификация гарантирует происхождение птицы и промышленный процесс, но проверка желтка на кровь остаётся ответственностью того, кто готовит, за исключением промышленных продуктов, уже прошедших сертифицированное просвечивание.</p>

<h2>Читать далее</h2>
<p>Это одна из самых простых привычек, которую можно внедрить в ежедневную кошерную кухню: проверять каждое яйцо сразу после его разбивания, прежде чем смешивать его с остальными ингредиентами. О других практических шагах повседневной жизни см. <a href="/articulos/armar-cocina-kosher">как организовать кошерную кухню с нуля</a>. А о другом парве-продукте со своими правилами проверки см. <a href="/articulos/insectos-frutas-verduras">насекомые во фруктах и овощах</a>.</p>',
            ],
            'pescado-kosher-aletas-escamas' => [
...
<h2>Что исключается из кашрута</h2>
<ul>
<li><strong>Все морепродукты</strong> (креветки, лангустины, крабы, мидии, устрицы): у них нет ни плавников, ни чешуи по любому критерию.</li>
<li><strong>Осьминог и кальмар:</strong> также не соответствуют критерию, не имея ни настоящих плавников, ни чешуи.</li>
<li><strong>Акула и морской чёрт:</strong> по мнению большинства галахических авторитетов, у них нет настоящей чешуи, хотя тема годами обсуждается разными раввинскими авторитетами.</li>
<li><strong>Угорь:</strong> не имеет видимой чешуи и исключается из кошерного критерия.</li>
<li><strong>Меч-рыба:</strong> её статус исторически является предметом споров между разными раввинскими авторитетами, и не каждый сертификатор относится к ней одинаково.</li>
</ul>

<h2>Почему кошерная рыба проще в приготовлении, чем мясо</h2>
<p>Важное отличие от мяса: кошерная рыба не требует ни <a href="/articulos/shejita-sacrificio-kosher">шхиты</a>, ни процесса засолки для удаления крови, что значительно упрощает её приготовление. Однако во многих традициях — особенно ашкеназских — рыбу рассматривают как категорию, отдельную от мяса и молочных продуктов, избегая сочетания её с мясом в одном блюде (хотя это не требует такого же строгого разделения посуды, как между мясом и молоком).</p>

<h2>Как проверять рыбу при покупке</h2>
<p>При покупке свежей рыбы стоит убедиться, что она сохраняет кожу с видимой чешуёй, поскольку при некоторых способах филетирования кожа полностью удаляется, что затрудняет проверку. Поэтому многие кошерные рыбные лавки оставляют идентифицируемый участок кожи на куске, обычно полоску возле хвоста, именно для того, чтобы можно было без сомнений подтвердить вид.</p>

<h2>Часто задаваемые вопросы</h2>
<p><strong>Кошерна ли икра?</strong><br>
Это зависит от исходной рыбы: икра осетра — спорная тема (из-за нетипичной чешуи осетра), тогда как икра других рыб с чёткими плавниками и чешуёй обычно принимается без проблем.</p>
<p><strong>Нужна ли сертификация для покупки свежей целой рыбы на рынке?</strong><br>
Это не обязательно, если вы сами можете проверить вид по его физическим характеристикам, хотя для переработанных продуктов (филе без кожи, консервы) стоит поискать сертификацию.</p>
<p><strong>Почему избегают сочетания рыбы с мясом, если оба пригодны по отдельности?</strong><br>
Это обычай, а не запрет той же категории, что мясо и молоко; он возник из исторической заботы о здоровье, которая больше не актуальна, но сохраняется как традиция во многих общинах.</p>

<h2>Читать далее</h2>
<p>Чтобы понять процесс, который действительно нужен мясу млекопитающих и птицы, см. <a href="/articulos/shejita-sacrificio-kosher">шхита: метод кошерного забоя</a>. А о другом ингредиенте животного происхождения со своими правилами см. <a href="/articulos/gelatina-kosher">кошерный желатин: галахический спор</a>.</p>',
            ],
            'frutos-secos-contaminacion-cruzada' => [
...
<h2>Самые распространённые риски</h2>
<ul>
<li><strong>Молочные ароматизаторы:</strong> орехи, "поджаренные с маслом" или покрытые молочным шоколадом, уже не являются парве и переходят в молочную категорию, со всеми ограничениями смешивания, которые это подразумевает.</li>
<li><strong>Общие линии:</strong> завод может обрабатывать орехи парве на том же оборудовании, где впоследствии обрабатываются молочные продукты или мясные производные, создавая некошерные следы при отсутствии сертифицированной очистки между партиями — то, что ни одна этикетка ингредиентов сама по себе не раскрывает.</li>
<li><strong>Масла для жарки:</strong> некоторые жареные орехи используют масла, общие с другими некошерными продуктами, что никак не отражается на конечном вкусе.</li>
<li><strong>Глазури и покрытия:</strong> "карамелизированные" орехи или с сладким покрытием могут содержать <a href="/articulos/gelatina-kosher">желатин</a> или другие ингредиенты животного происхождения в глазури.</li>
</ul>

<h2>Почему это встречается чаще, чем кажется</h2>
<p>Многие ореховые фабрики обрабатывают десятки сортов и вариантов на одном предприятии, чтобы использовать то же оборудование по максимуму: линия, которая сегодня обжаривает обычный миндаль, вчера могла обрабатывать партию, покрытую молочным шоколадом. Без сертифицированной очистки между партиями (или без линий, посвящённых исключительно продуктам парве) остаётся достаточно следов, чтобы продукт больше не считался парве по строгому критерию.</p>

<h2>Как снизить риск на практике</h2>
<p>Сырой, необработанный орех, купленный на развес у надёжного поставщика или в своей исходной скорлупе, почти никогда не вызывает проблем. Но промышленные продукты (ореховые смеси, ароматизированные закуски, зерновые батончики) всегда следует проверять на сертификацию, не предполагая, что они автоматически кошерны только потому, что главный ингредиент таков. Это в равной мере касается продуктов, продаваемых как "натуральные" или "без добавок": эти пометки ничего не говорят об общем оборудовании.</p>

<h2>Часто задаваемые вопросы</h2>
<p><strong>Орехи на развес без марки более рискованны, чем упакованные?</strong><br>
Могут быть, поскольку нет способа отследить происхождение или процесс; стоит покупать их в надёжных магазинах или предпочитать сертифицированные марки.</p>
<p><strong>Несёт ли арахисовое масло тот же риск?</strong><br>
Да, и иногда даже больше, поскольку оно часто содержит дополнительные масла и стабилизаторы, также требующие проверки, помимо самого арахиса.</p>
<p><strong>Меняют ли пророщенные или замоченные дома орехи анализ?</strong><br>
Нет, если исходный орех был сырым и не обработан промышленно, замачивание его дома не вносит никакого нового риска кашрута.</p>

<h2>Читать далее</h2>
<p>О другом ингредиенте, где промышленная обработка — ключевая проблема, см. <a href="/articulos/gelatina-kosher">кошерный желатин: галахический спор</a>. А чтобы понять, как читать всю релевантную информацию на этикетке, см. <a href="/articulos/como-leer-etiqueta-kosher">как читать этикетку кошерного продукта</a>.</p>',
            ],
            'kashrut-y-veganismo' => [
...
<h2>Случаи, когда веганский продукт может не быть кошерным</h2>
<ul>
<li><strong>Общее оборудование:</strong> веганская фабрика может использовать ту же производственную линию, на которой ранее обрабатывались мясные или молочные продукты, без сертифицированной очистки, которую кашрут требует между партиями, — проблема, похожая на рассмотренную в <a href="/articulos/frutos-secos-contaminacion-cruzada">орехах и перекрёстном загрязнении</a>.</li>
<li><strong>Вино и его производные:</strong> веганское вино (без осветлителей животного происхождения) всё равно требует, чтобы весь процесс производства находился в руках соблюдающих евреев, чтобы быть кошерным, как объяснено в <a href="/articulos/vino-kosher">кошерном вине</a>.</li>
<li><strong>Насекомые:</strong> определённые красители (например, кармин, животного происхождения, извлекаемый из насекомого) запрещены в кошерной пище, но иногда ошибочно маркируются как подходящие для веганов или по другим стандартам веганской сертификации.</li>
<li><strong>Бишуль акум:</strong> веганская еда, полностью приготовленная неевреем, может подпадать под это ограничение, в зависимости от классификации продукта (см. <a href="/articulos/bishul-akum">бишуль акум</a>).</li>
</ul>

<h2>Почему веганская и кошерная сертификации не совпадают полностью</h2>
<p>Веганские сертификации сосредоточены почти исключительно на происхождении ингредиентов: без мяса, молока, яиц, мёда и любых животных производных. Кашрут смотрит на это тоже, но также проверяет весь процесс: какое оборудование использовалось, кто присутствовал на определённых этапах приготовления, и был ли контакт с некошерными продуктами в какой-либо точке цепочки. Это системы проверки с разными целями, хотя они пересекаются на многих продуктах.</p>

<h2>Обратное направление: кошерное не всегда веганское</h2>
<p>И обратное тоже верно: многие кошерные продукты парве на самом деле являются веганскими, потому что "парве" уже исключает мясо и молоко. Но продукт может быть кошерным и не веганским без какого-либо противоречия: йогурт с кошерной молочной сертификацией, например, полностью действителен для кашрута и не подходит для веганов.</p>

<h2>Часто задаваемые вопросы</h2>
<p><strong>Существует ли сертификация, объединяющая оба критерия в одном знаке?</strong><br>
Некоторые сертификаторы предлагают комбинированные обозначения ("Kosher Pareve" рядом с веганским знаком того же производителя), но это два отдельных процесса проверки, а не одна процедура.</p>
<p><strong>Нужна ли 100% веганскому ресторану отдельная кошерная сертификация, чтобы быть надёжным?</strong><br>
Да, если он стремится считаться кошерным: тот факт, что все блюда веганские, автоматически не решает вопрос оборудования или того, кто готовит.</p>
<p><strong>Мёд веганский или кошерный?</strong><br>
Мёд кошерен (заметное исключение, поскольку он происходит от насекомого, но галаха его разрешает), но он не веганский, поскольку большинство веганских сертификаций исключают любой продукт животного происхождения, включая насекомых.</p>

<h2>Читать далее</h2>
<p>Чтобы понять, почему вино требует такого особого надзора, даже будучи веганским, см. <a href="/articulos/vino-kosher">кошерное вино</a>. А о риске перекрёстного загрязнения в казалось бы простых продуктах см. <a href="/articulos/frutos-secos-contaminacion-cruzada">орехи и кашрут</a>.</p>',
            ],
            'separar-la-jala' => [
...
<h2>Когда применяется эта мицва</h2>
<p>Эта мицва применяется при замешивании значительного количества теста из одного из пяти злаков (пшеницы, ячменя, овса, ржи или спельты) — точное минимальное количество (обычно около 1,2 кг муки) варьируется в зависимости от соблюдаемого галахического мнения. Ниже этого количества отделение не обязательно, хотя некоторые обычаи всё равно его выполняют, без благословения.</p>
...
<li>Произнести соответствующее благословение перед отделением части, если количество теста достигает минимума, требующего этого.</li>
...
<h2>Семейный ритуал, помимо технического жеста</h2>
...
<p>Со временем многие семьи превращают этот момент в почти еженедельный обычай, особенно при выпечке хлеба или халы на Шаббат: старшие девочки в доме берут на себя расчёт количества муки, чтобы гарантировать достижение минимума, и момент отделения части с благословением становится постоянной частью пятничной рутины.</p>

<h2>Часто задаваемые вопросы</h2>
<p><strong>Нужно ли отделять халу, если замешиваю мало теста, для небольшой семьи?</strong><br>
Если минимальное количество муки не достигнуто, отделение не обязательно по галахе, хотя некоторые семьи всё равно делают это, без благословения, по обычаю.</p>
<p><strong>Можно ли отделять халу от теста, не предназначенного специально для хлеба (например, для выпечки)?</strong><br>
Да, мицва применяется к любому тесту из пяти злаков, достигающему минимального количества, не только к традиционному хлебу.</p>
<p><strong>Что делать, если забыл отделить халу перед выпечкой?</strong><br>
Можно отделить даже после выпечки хлеба, хотя лучше сделать это заранее; проконсультируйтесь с раввином, если возникнет этот конкретный вопрос.</p>

<h2>Читать далее</h2>
<p>Если хотите углубиться, <a href="https://oukosher.org/the-kosher-primer/" target="_blank" rel="noopener">руководство Orthodox Union</a> раскрывает законы хафрашат хала с их источниками, а также можно ознакомиться со статьёй <a href="https://ru.wikipedia.org/wiki/%D0%A5%D0%B0%D0%BB%D0%B0_(%D1%85%D0%BB%D0%B5%D0%B1)" target="_blank" rel="noopener">Википедии о хале</a> для исторического контекста и региональных вариантов хлеба. О других праздниках и пищевых обычаях еврейского календаря см. <a href="/articulos/calendario-judio-festividades-alimentacion">еврейский календарь и праздники</a>.</p>',
            ],
            'calendario-judio-festividades-alimentacion' => [
                ...
                'content' => '<p>Помимо правил кашрута, действующих круглый год, еврейский календарь приносит праздники со своими собственными пищевыми обычаями, и их знание помогает понять, почему определённые продукты появляются и исчезают с полок в определённые периоды.</p>
...
<h2>Обзор праздник за праздником</h2>
<ul>
<li><strong>Рош а-Шана:</strong> принято есть яблоко с мёдом, символизируя сладкий год, и избегать горьких или кислых продуктов на праздничном столе. Также принято есть гранат, символически считая его зёрна как заслуги, желаемые на новый год.</li>
<li><strong>Йом Кипур:</strong> день полного 25-часового поста, без еды и питья, за исключением особых медицинских случаев. Трапеза перед постом обычно обильная, но простая, избегая слишком солёных продуктов, вызывающих жажду.</li>
<li><strong>Суккот:</strong> принято есть в временной хижине под открытым небом (сукке) на протяжении всей недели праздника, воссоздавая временные жилища исхода из Египта.</li>
<li><strong>Ханука:</strong> традиция есть жареную в масле пищу (например, суфганиёт, пончики с начинкой, и латкес, картофельные оладьи) в память о чуде с маслом, длившемся восемь дней.</li>
<li><strong>Пурим:</strong> готовят гоменташи (уши Амана), треугольные пирожки с начинкой, и принято делиться корзинами с едой (мишлоах манот) с друзьями и семьёй, а также праздничной трапезой (сеуда) во второй половине дня.</li>
<li><strong>Песах:</strong> праздник с наибольшим количеством пищевых ограничений, сосредоточенный на запрете <a href="/articulos/jametz-pesaj">хамеца</a>, с мацой как центральным продуктом всей недели.</li>
<li><strong>Шавуот:</strong> обычай есть молочные продукты, с такими блюдами, как чизкейк и блинчики с сыром (блинцес) в качестве главных героев, в память о даровании Торы.</li>
</ul>

<h2>Почему это влияет на то, что видно на полках</h2>
<p>Поэтому продукты, такие как маца, суфганиёт или кошерное вино для Песаха, появляются в гораздо большем количестве на полках и в магазинах непосредственно перед каждым праздником и часто полностью исчезают в остальное время года. Для тех, кто не знаком с еврейским календарём, это может показаться хаотичным; на самом деле это следует довольно предсказуемому годовому циклу, когда известны даты.</p>

<h2>Лунный календарь: почему даты "смещаются"</h2>
<p>Еврейский календарь лунно-солнечный, что заставляет праздники выпадать на разные даты григорианского календаря каждый год, хотя всегда в одно и то же время года (Песах всегда весной северного полушария, например). Стоит проверять конкретный еврейский календарь каждого года, а не запоминать фиксированную дату.</p>

<h2>Часто задаваемые вопросы</h2>
<p><strong>У всех этих праздников тот же уровень пищевых ограничений, что и у Песаха?</strong><br>
Нет, Песах самый строгий с точки зрения того, что можно и нельзя есть или иметь. У остальных есть конкретные пищевые обычаи, но не тот же полный запрет на определённые продукты.</p>
<p><strong>Есть ли праздники, когда можно есть хамец даже близко к Песаху?</strong><br>
Да, вне конкретного периода Песаха нет ограничения на хамец; запрет действует только в дни этого праздника.</p>
<p><strong>Почему у рыбы или мяса нет праздника, связанного с ними, как у молочных продуктов с Шавуот?</strong><br>
Единой причины нет; обычай есть молочные продукты на Шавуот просто имеет конкретные исторические и символические корни, которые не воспроизвелись так же с другими продуктами на других праздниках.</p>

<h2>Читать далее</h2>
<p>Чтобы углубиться в праздник с наибольшим количеством пищевых правил года, см. <a href="/articulos/jametz-pesaj">хамец: что это и как его устранить перед Песахом</a>. А о посуде, которую многие семьи откладывают специально для этого периода, см. <a href="/articulos/vajilla-para-pesaj">посуда для Песаха</a>.</p>',
            ],
            'errores-comunes-empezar-comer-kosher' => [
                ...
                'content' => '<p>Начало соблюдения кошерной диеты — это процесс, требующий времени, и нормально совершать ошибки в начале. Рассмотрим самые распространённые, чтобы их было легче избежать с самого начала.</p>
...
<ul>
<li><strong>Предположение, что "натуральный" или "без консервантов" означает кошерный:</strong> маркетинг продукта не имеет прямого отношения к его статусу кашрута. Всегда нужно искать сертификацию, независимо от того, насколько простым выглядит список ингредиентов.</li>
<li><strong>Не проверять продукты, которые кажутся явно парве:</strong> закуски, выпечка и сладости иногда содержат молочные ингредиенты или <a href="/articulos/gelatina-kosher">желатин</a>, не очевидные из названия продукта.</li>
<li><strong>Случайно смешивать мясную и молочную посуду:</strong> в начале легко забыть о разделении; маркировка или использование разных цветов очень помогает во время перехода, как подробно описано в <a href="/articulos/armar-cocina-kosher">как организовать кошерную кухню с нуля</a>.</li>
<li><strong>Не проверять листовые овощи на наличие насекомых:</strong> шаг, о котором многие новички в кашруте совершенно не подозревают, и который особенно касается зелёных листовых овощей.</li>
<li><strong>Доверять неизвестным или неясным сертификациям:</strong> не все символы на упаковке являются настоящими кошерными сертификациями; некоторые из них — знаки качества, не связанные с кашрутом. Стоит научиться их различать.</li>
<li><strong>Не спрашивать:</strong> многие сомнения быстро разрешаются с помощью консультации с раввином общины или с более опытным человеком, вместо того чтобы гадать или по умолчанию выбирать самый строгий (или самый мягкий) критерий на всякий случай.</li>
</ul>

<h2>Почему стоит идти постепенно</h2>
<p>Одна из самых тихих ошибок — желание решить всё сразу: переделать всю кухню, выучить все правила и перестать есть вне дома в тот же день, когда решаешь начать. На практике те, кто поддерживает изменение в долгосрочной перспективе, обычно продвигаются поэтапно, отдавая приоритет сначала тому, что готовится дома, и оставляя на потом более сложные решения, такие как еда в ресторанах или организация мероприятий.</p>

<h2>Часто задаваемые вопросы</h2>
<p><strong>Нужен ли сертификатор-ориентир с первого дня?</strong><br>
Это не обязательно, но очень помогает: выбор одного-двух признанных сертификаторов как ориентира упрощает решения о покупках с самого начала, вместо оценки каждого знака отдельно.</p>
<p><strong>Сколько времени нужно, чтобы почувствовать себя комфортно с базовыми правилами?</strong><br>
Это сильно варьируется от человека к человеку, но большинство сообщают о большей уверенности после нескольких месяцев постоянной практики, особенно когда проверка этикеток становится автоматической привычкой.</p>
<p><strong>Есть ли ошибка, которую особенно трудно исправить потом?</strong><br>
Повторное смешивание мясной и молочной посуды может усложнить кухню в долгосрочной перспективе больше, чем другие ошибки, поскольку может потребовать откошерования или замены предметов; поэтому стоит решить физическое разделение как можно скорее.</p>

<h2>Читать далее</h2>
<p>Самое важное — понять, что переход не обязан быть идеальным с первого дня. Большинство еврейских общин ценят постепенный процесс обучения, и существует множество ресурсов — включая сертификаторов, раввинов и инструменты, такие как KosherMap, — чтобы сопровождать этот путь. Для первых конкретных шагов см. <a href="/articulos/armar-cocina-kosher">как организовать кошерную кухню с нуля</a>, а чтобы узнать, что смотреть на каждой этикетке, см. <a href="/articulos/como-leer-etiqueta-kosher">как читать этикетку кошерного продукта</a>.</p>',
            ],
        ];
    }
}
