...
<p>בלילה שלפני פסח מתבצע חיפוש טקסי אחר חמץ בכל הבית (בדיקת חמץ), בדרך כלל עם נר, נוצה וכף עץ, ולאחריו שריפת מה שנמצא (ביעור חמץ) למחרת בבוקר.</p>',
            ...
            'vino-kosher' => [
                ...
                'content' => '<p>בניגוד לרוב המאכלים, שבהם די בכך שהמרכיבים והתהליך עומדים בדרישות מסוימות, יין כשר דורש בנוסף שכל אדם הנוגע בו במהלך ייצורו — מקטיף הענבים ועד הבקבוק — יהיה יהודי ושומר מצוות. כלל זה נוצר היסטורית כדי למנוע שימוש ביין בטקסי עבודה זרה.</p>
<p>זה אומר שיקב המייצר יין כשר חייב לפעול תחת השגחה רבנית מתמדת: עובדים לא יהודים יכולים לסייע במשימות שאינן כוללות מגע ישיר עם היין או מיץ הענבים, אך התהליך המרכזי חייב להישאר בידי צוות יהודי שומר מצוות.</p>
<p>קיימת קטגוריה מיוחדת הנקראת <strong>יין מבושל</strong>, שהוא יין שעבר פסטור בטמפרטורה ספציפית. לאחר שהוא מבושל, היין שומר על מעמדו הכשר גם אם מוגש או נגוע על ידי אדם לא יהודי, מה שהופך אותו לפרקטי הרבה יותר עבור אירועים, מסעדות וקייטרינג שבהם לא ניתן להבטיח שרק יהודים יטפלו בבקבוקים.</p>
<p>כיום קיימים יינות כשרים איכותיים כמעט בכל אזורי הגפן בעולם, כולל ארגנטינה, צ\'ילה, צרפת, ספרד, איטליה וכמובן ישראל, המוסמכים על ידי הכשרויות המובילות.</p>',
            ],
            'gelatina-kosher' => [
...
<p>В ночь перед Песахом проводится ритуальный поиск хамеца по всему дому (бдикат хамец), обычно со свечой, пером и деревянной ложкой, за которым следует сжигание найденного (биур хамец) на следующее утро.</p>',
            ...
            'vino-kosher' => [
                ...
                'content' => '<p>В отличие от большинства продуктов, где достаточно соответствия ингредиентов и процесса определённым требованиям, кошерное вино дополнительно требует, чтобы каждый, кто прикасается к нему в процессе производства — от сбора винограда до розлива в бутылки, — был соблюдающим евреем. Это правило исторически возникло, чтобы предотвратить использование вина в идолопоклоннических ритуалах.</p>
<p>Это означает, что винодельня, производящая кошерное вино, должна работать под постоянным раввинским надзором: нееврейские работники могут помогать в задачах, не связанных с непосредственным прикосновением к вину или виноградному соку, но основной процесс должен оставаться в руках соблюдающего еврейского персонала.</p>
<p>Существует особая категория, называемая <strong>мевушаль</strong> (буквально "варёное"), — это вино, пастеризованное при определённой температуре. После мевушаль вино сохраняет свой кошерный статус, даже если его подаёт или трогает нееврей, что делает его гораздо более практичным для мероприятий, ресторанов и кейтеринга, где нельзя гарантировать, что бутылки будут трогать только евреи.</p>
<p>Сегодня качественное кошерное вино производится практически во всех винодельческих регионах мира, включая Аргентину, Чили, Францию, Испанию, Италию и, конечно, Израиль, сертифицированное ведущими раввинскими агентствами.</p>',
            ],
            'gelatina-kosher' => [
